...
class DistributedBattleBldgAI(DistributedBattleBaseAI.DistributedBattleBaseAI):
    ...
    def __init__(self, air, zoneId, roundCallback=None, finishCallback=None, maxSuits=4, bossBattle=0, suitBldgType=0):
        DistributedBattleBaseAI.DistributedBattleBaseAI.__init__(self, air, zoneId, finishCallback, maxSuits, bossBattle, suitBldgType=suitBldgType)
        self.streetBattle = 0
