...
SUIT_HP_COL = 5
TOON_DIED_COL = 6
SUIT_BEFORE_TOONS_COL = 7
SUIT_TAUNT_COL = 8
EFFECT_SUIT_ID_COL = 0
EFFECT_ATK_COL = 1
EFFECT_TGT_COL = 2
EFFECT_HP_COL = 3
EFFECT_ROUNDS_COL = 4
...
def attackAffectsGroup(track, level, type = None):
    if track == NPCSOS or type == NPCSOS or track == PETSOS or type == PETSOS or track == TAUNT:
        return 1
...
def getDefaultSuitAttack():
    return [NO_ID, NO_ATTACK, 0, -1, -1, [], 0, 0, 0]
    
def getDefaultEffectAttack():
    # Suit ID, Attack, Target IDs, dmg, toonDied
...
REVIVE_SCREEN_TIME = 10
REVIVE_TIME_PER_TOON = 4
DEATH_TIME = 8

class BattleBase:
    notify = DirectNotifyGlobal.directNotify.newCategory('BattleBase')
    suitPoints = (
     ((Point3(0, 5, 0), 179),), # 1 Cog
     ((Point3(2, 5.3, 0), 170), (Point3(-2, 5.3, 0), 180)), # 2 Cogs
     ((Point3(4, 5.2, 0), 170), (Point3(0, 6, 0), 179), (Point3(-4, 5.2, 0), 190)), # 3 Cogs
     ((Point3(6, 4.4, 0), 160), # 4 Cogs
      (Point3(2, 6.3, 0), 170),
      (Point3(-2, 6.3, 0), 190),
      (Point3(-6, 4.4, 0), 200)),
     ((Point3(8, 5.4, 0), 163), # 5 Cogs
      (Point3(4, 6.2, 0), 170),
      (Point3(0, 7, 0), 179),
      (Point3(-4, 6.2, 0), 190),
      (Point3(-8, 5.4, 0), 197)),
     ((Point3(10, 4.4, 0), 155), # 6 Cogs
      (Point3(6, 5.4, 0), 160),
      (Point3(2, 7.3, 0), 170),
      (Point3(-2, 7.3, 0), 190),
      (Point3(-6, 5.4, 0), 200),
