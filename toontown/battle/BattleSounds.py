    ...
    def setupSearchPath(self):
        ...
        if AppRunnerGlobal.appRunner:
            ...
            if sys.platform == 'android':
                self.sfxSearchPath.appendDirectory(Filename(currentDirectory + '/resources/phase_3/audio/sfx'))
                self.sfxSearchPath.appendDirectory(Filename(currentDirectory + '/resources/phase_3.5/audio/sfx'))
                self.sfxSearchPath.appendDirectory(Filename(currentDirectory + '/resources/phase_4/audio/sfx'))
                self.sfxSearchPath.appendDirectory(Filename(currentDirectory + '/resources/phase_5/audio/sfx'))
