...
Props = ((5, 'partyBall', 'partyBall'),
 ...
 (4,
  ...
  'SZ_splashdown-mod',
  'SZ_splashdown-chan'))
CupcakeColor = VBase4(250.0 / 255.0, 241.0 / 255.0, 24.0 / 255.0, 1.0)
CreampieColor = VBase4(1.0, 1.0, 1.0, 1.0)
...
class PropPool:
    ...
    def __init__(self):
        ...
        propName = 'tart'
        self.propStrings[propName] = (self.getPath(5, 'cupcake'),)
        self.propTypes[propName] = 'model'
        propName = 'fruitpie'
    ...
    def __getPropCopy(self, name):
        if self.propTypes[name] == 'actor':
            if name not in self.props:
                ...
                if name not in ToontownBattleGlobals.pieNames and 'splat' not in name:
