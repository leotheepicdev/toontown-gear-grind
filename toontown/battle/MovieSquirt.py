...
missSoundFiles = ('AA_squirt_flowersquirt_miss.ogg', 'AA_squirt_glasswater_miss.ogg', 'AA_squirt_neonwatergun_miss.ogg', 'AA_squirt_seltzer_miss.ogg', 'firehose_spray.ogg', 'AA_throw_stormcloud_miss.ogg', 'AA_squirt_Geyser_miss.ogg')
sprayScales = [0.2,
 0.3,
 0.1,
 0.6,
...
def __doWaterGlass(squirt, delay, fShowStun):
    ...
    tracks = Parallel()
    tracks.append(Sequence(ActorInterval(toon, 'spit'), Func(toon.loop, 'neutral')))
