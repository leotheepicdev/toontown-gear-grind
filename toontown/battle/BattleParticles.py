    ...
    if particleSearchPath == None:
        ...
        if AppRunnerGlobal.appRunner:
            ...
            if sys.platform == 'android':
                self.sfxSearchPath.appendDirectory(Filename(currentDirectory + '/resources/phase_3.5/etc'))
                self.sfxSearchPath.appendDirectory(Filename(currentDirectory + '/resources/phase_4/etc'))
                self.sfxSearchPath.appendDirectory(Filename(currentDirectory + '/resources/phase_5/etc'))
                self.sfxSearchPath.appendDirectory(Filename(currentDirectory + '/resources/phase_8/etc'))
                self.sfxSearchPath.appendDirectory(Filename(currentDirectory + '/resources/phase_9/etc'))
