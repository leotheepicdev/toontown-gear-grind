...
throwSoundFiles = ('AA_pie_throw_only.ogg', 'AA_throw_fruitpie.ogg', 'AA_throw_creampie.ogg', 'AA_throw_wfruitpie.ogg', 'AA_throw_wcreampie.ogg', 'AA_throw_bdaycake.ogg')
hitSoundFiles = ('AA_tart_only.ogg', 'AA_throw_fruitpie_only.ogg', 'AA_throw_creampie_only.ogg', 'AA_throw_wfruitpie_only.ogg', 'AA_throw_wcreampie_only.ogg', 'AA_throw_bdaycake_only.ogg')
missSoundFiles = ('AA_tart_only.ogg', 'AA_throw_fruitpie_miss_only.ogg', 'AA_throw_creampie_miss_only.ogg', 'AA_throw_wfruitpie_miss_only.ogg', 'AA_throw_wcreampie_miss_only.ogg', 'AA_throw_bdaycake_miss_only.ogg')
tPieLeavesHand = 2.7
tPieHitsSuit = 3.0
tSuitDodges = 2.45
ratioMissToHit = 1.5
...
def __getSoundTrack(level, hitSuit, node = None):
    ...
    throwSound = globalBattleSoundCache.getSound(throwSoundFiles[level])
    ...
    if hitSuit:
        ...
        missSound = globalBattleSoundCache.getSound(missSoundFiles[level])
        missTrack = Sequence(Wait(tPieLeavesHand), Wait(0.65), SoundInterval(missSound, node=node))
        return Parallel(throwTrack, missTrack)
...
def __createWeddingCakeFlight(throw, groupHitDict, pie, pies):
    ...
    hands = toon.getRightHands()
    extraPie = MovieUtil.copyProp(pie)
    extraPie.reparentTo(hands[0])
    extraPie.hide()
    splatType = globalPropPool.getPropType(splatName)
    cakePartStrs = ['cake1',
     'cake2',
    ...
    for part in cakePartStrs:
        cakeParts.append(extraPie.find('**/%s' % part))
    ...
    cakePartDivisions[4] = [[cakeParts[0]],
     ...
     [cakeParts[2]],
     [cakeParts[3]]]
    cakePartDivisions[5] = [[cakeParts[0]], [cakeParts[1]], [cakeParts[2]], [cakeParts[3]], [cakeParts[4]]]
    cakePartDivisions[6] = [[cakeParts[0]], [cakeParts[1]], [cakeParts[2]],[cakeParts[3]], [cakeParts[4]], [cakeParts[5]]]
