...
class Motion(StateData.StateData):
    ...
    def enterWalk(self, rate = 0):
        ...
        Emote.globalDisguiseEmote.disableBody(self.lt, 'enterWalk')

    def exitWalk(self):
        self.notify.debug('exitWalk')
        Emote.globalEmote.releaseBody(self.lt, 'exitWalk')
        Emote.globalDisguiseEmote.releaseBody(self.lt, 'exitWalk')
    ...
    def exitRun(self):
        ...
        Emote.globalDisguiseEmote.releaseBody(self.lt, 'enterWalk')
