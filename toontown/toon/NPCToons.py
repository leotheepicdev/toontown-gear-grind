...
PURCHASE_MOVIE_AVATAR_REJECT = 11
SELL_MOVIE_CLEAR = 0
SELL_MOVIE_START = 1
SELL_MOVIE_COMPLETE = 2
SELL_MOVIE_NOFISH = 3
SELL_MOVIE_TROPHY = 4
SELL_MOVIE_TROPHY_BUCKET = 5
...
NPC_SCIENTIST = 11
NPC_GLOVE = 12
NPC_CHEESY_CLEANER = 13
NPC_NAMETAG_COLOR = 14
NPC_LONELY_LOUIS = 15
CLERK_COUNTDOWN_TIME = 120
TAILOR_COUNTDOWN_TIME = 300
NAMETAG_COLOR_COUNTDOWN_TIME = 600
...
def createNPC(air, npcId, desc, zoneId, posIndex = 0, questCallback = None):
    ...
    from . import DistributedNPCCheesyCleanerAI
    from . import DistributedNPCNametagColorAI
    from . import DistributedNPCLonelyLouisAI
    ...
    elif type == NPC_CHEESY_CLEANER:
        npc = DistributedNPCCheesyCleanerAI.DistributedNPCCheesyCleanerAI(air, npcId)
    elif type == NPC_NAMETAG_COLOR:
        npc = DistributedNPCNametagColorAI.DistributedNPCNametagColorAI(air, npcId)
    elif type == NPC_LONELY_LOUIS:
        npc = DistributedNPCLonelyLouisAI.DistributedNPCLonelyLouisAI(air, npcId)
    else:
...
NPCToonDict = {
 ...
 20002: (-1, lnames[20002], ('dls', 'ms', 'm', 'm', 6, 0, 6, 6, 0, 10, 0, 10, 0, 9), 'm', 1, NPC_HQ),
 999: (-1, lnames[999], 'r', 'm', 1, NPC_TAILOR),
 1000: (-1, lnames[1000], 'r', 'm', 1, NPC_HQ),
 20001: (-1, lnames[2001], ('dss', 'ms', 'm', 'm', 17, 0, 17, 17, 3, 3, 3, 3, 8, 2), 'm', 1, NPC_BLOCKER),
 ...
 2011: (2519, lnames[2011], ('rll', 'ms', 'l', 'f', 2, 0, 2, 2, 1, 9, 1, 9, 40, 27, (3, 1, 0)), 'f', 1, NPC_CLERK),
 ...
 2012: (2000, lnames[2012], ('rss', 'ls', 'l', 'm', 17, 0, 17, 17, 1, 6, 1, 6, 1, 1, (18, 0, 0)), 'm', 1, NPC_FISHERMAN),
 ...
 2016: (2000, lnames[2016], ('sls', 'ls', 'm', 'm', 10, 0, 9, 9, 0, 3, 0, 3, 0, 18, (12, 0, 0)), 'm', 1, NPC_PARTYPERSON),
 2017: (2000, lnames[2017], ('sss', 'ld', 'm', 'f', 10, 0, 9, 9, 0, 23, 0, 23, 0, 5, (12, 0, 0)), 'f', 1, NPC_PARTYPERSON),
 2018: (2513, lnames[2019], ('fll', 'ss', 's', 'm', 15, 0, 15, 15, 99, 27, 86, 27, 60, 27), 'm', 1, NPC_SCIENTIST),
 2019: (2513, lnames[2018], ('pls', 'ls', 'l', 'm', 9, 0, 9, 9, 98, 27, 86, 27, 59, 27), 'm', 1, NPC_SCIENTIST),
 2020: (2513, lnames[2020], ('hss', 'ms', 'm', 'm', 20, 0, 20, 20, 97, 27, 86, 27, 58, 27), 'm', 1, NPC_SCIENTIST),
 2021: (2523, lnames[2021], ('cls', 'ss', 'm', 'f', 24, 0, 24, 24, 0, 0, 0, 0, 0, 3), 'f', 1, NPC_NAMETAG_COLOR),
 2022: (2524, lnames[2022], ('pll', 'ls', 'm', 'm', 22, 0, 22, 22, 1, 27, 1, 27, 0, 13), 'm', 0, NPC_GLOVE),
 ...
 2108: (2603, lnames[2108], ('csl', 'ms', 'm', 'f', 7, 0, 7, 7, 1, 24, 1, 24, 3, 2, (43, 0, 0)), 'f', 0, NPC_REGULAR),
 ...
 2140: (2156, lnames[2140], ('dls', 'ls', 'l', 'm', 10, 0, 10, 10, 1, 9, 1, 9, 1, 10, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 2142: (2652, lnames[2142], ('dls', 'ls', 'm', 'f', 1, 0, 1, 1, 1, 27, 1, 27, 1, 27), 'm', 1, NPC_REGULAR),
 ...
 2216: (2728, lnames[2216], ('fll', 'sd', 'm', 'f', 11, 0, 11, 11, 0, 25, 0, 25, 12, 27), 'f', 0, NPC_CHEESY_CLEANER),
 2217: (2729, lnames[2217], ('fsl', 'ss', 'm', 'm', 4, 0, 4, 4, 0, 12, 0, 12, 0, 20), 'm', 1, NPC_REGULAR),
 2218: (2730, lnames[2218], 'r', 'f', 0, NPC_REGULAR),
 2219: (2732, lnames[2219], ('rll', 'ms', 'm', 'm', 10, 0, 10, 10, 0, 27, 0, 27, 0, 14, (25, 0, 0)), 'm', 0, NPC_REGULAR),
 ...
 2225: (2236, lnames[2225], ('cll', 'ls', 'm', 'm', 9, 0, 9, 9, 1, 1, 1, 1, 0, 13, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 2227: (2747, lnames[2227], ('css', 'md', 'l', 'f', 11, 0, 11, 11, 0, 0, 0, 0, 0, 27), 'f', 0, NPC_REGULAR),
 ...
 2321: (2341, lnames[2321], ('fsl', 'ss', 'l', 'm', 21, 0, 21, 21, 1, 5, 1, 5, 0, 12, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 2322: (2833, lnames[2322], ('bll', 'ls', 'l', 'm', 22, 0, 22, 22, 0, 27, 0, 27, 0, 9), 'm', 1, NPC_REGULAR),
 ...
 1008: (1000, lnames[1008], ('cls', 'ms', 'm', 'm', 3, 0, 3, 3, 0, 27, 0, 27, 0, 17, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 ...
 1012: (1000, lnames[1012], ('fls', 'ms', 'l', 'm', 14, 0, 3, 3, 0, 1, 0, 1, 0, 13, (12, 0, 0)), 'm', 1, NPC_PARTYPERSON),
 1013: (1000, lnames[1013], ('fss', 'ms', 'm', 'f', 2, 0, 3, 3, 1, 6, 1, 6, 5, 6, (12, 0, 0)), 'f', 1, NPC_PARTYPERSON),
 ...
 1126: (1129, lnames[1126], ('cls', 'ms', 'l', 'm', 4, 0, 4, 4, 1, 11, 1, 11, 0, 19, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 ...
 1228: (1236, lnames[1228], ('cll', 'ms', 'l', 'm', 8, 0, 8, 8, 1, 9, 1, 9, 1, 0, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 ...
 1332: (1330, lnames[1332], ('cll', 'ms', 'm', 'm', 5, 0, 5, 5, 0, 4, 0, 4, 1, 13, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 ...
 3009: (3000, lnames[3009], ('rss', 'ls', 'l', 'f', 19, 0, 19, 19, 0, 26, 0, 26, 4, 23, (18, 0, 0)), 'f', 0, NPC_FISHERMAN),
 ...
 3013: (3000, lnames[3013], ('cls', 'ss', 'm', 'm', 18, 0, 17, 17, 1, 7, 1, 7, 1, 9, (12, 0, 0)), 'm', 1, NPC_PARTYPERSON),
 3014: (3000, lnames[3014], ('css', 'sd', 'm', 'f', 17, 0, 16, 16, 0, 24, 0, 24, 0, 9, (12, 0, 0)), 'f', 1, NPC_PARTYPERSON),
 ...
 3112: (3607, lnames[3112], ('rll', 'ls', 'm', 'm', 21, 0, 21, 21, 1, 5, 1, 5, 1, 9, (39, 0, 0)), 'm', 0, NPC_REGULAR),
 ...
 3140: (3136, lnames[3140], ('rll', 'ms', 'l', 'f', 11, 0, 11, 11, 0, 3, 0, 3, 12, 27, (18, 0, 0)), 'f', 0, NPC_FISHERMAN),
 ...
 3232: (3236, lnames[3232], ('rls', 'ss', 'm', 'm', 3, 0, 3, 3, 0, 10, 0, 10, 1, 9, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 ...
 3307: (3329, lnames[3307], ('rss', 'ls', 'm', 'f', 11, 0, 11, 11, 1, 24, 1, 24, 1, 9, (18, 0, 0)), 'f', 0, NPC_FISHERMAN),
 3308: (3815, lnames[3308], ('mss', 'ss', 'l', 'm', 3, 0, 3, 3, 1, 11, 1, 11, 1, 0, (23, 0, 0)), 'm', 0, NPC_REGULAR),
 ...
 4009: (4000, lnames[4009], ('hsl', 'ld', 'm', 'f', 19, 0, 19, 19, 1, 6, 1, 6, 12, 27, (18, 0, 0)), 'f', 0, NPC_FISHERMAN),
 ...
 4013: (4000, lnames[4013], ('bll', 'ls', 's', 'm', 3, 0, 19, 19, 0, 8, 0, 8, 1, 12, (12, 0, 0)), 'm', 1, NPC_PARTYPERSON),
 4014: (4000, lnames[4014], ('bss', 'md', 'm', 'f', 24, 0, 19, 19, 0, 24, 0, 24, 0, 12, (12, 0, 0)), 'f', 1, NPC_PARTYPERSON),
 ...
 4141: (4148, lnames[4141], ('hll', 'ms', 'l', 'm', 4, 0, 4, 4, 1, 8, 1, 8, 1, 4, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 ...
 4235: (4240, lnames[4235], ('cls', 'ls', 'm', 'm', 3, 0, 3, 3, 1, 3, 1, 3, 1, 16, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 ...
 4335: (4345, lnames[4335], ('hsl', 'ms', 'l', 'm', 22, 0, 22, 22, 1, 0, 1, 0, 0, 6, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 ...
 5008: (5000, lnames[5008], ('cll', 'md', 's', 'f', 4, 0, 4, 4, 1, 22, 1, 22, 19, 27, (18, 0, 0)), 'f', 0, NPC_FISHERMAN),
 ...
 5012: (5000, lnames[5012], ('dls', 'ms', 'm', 'm', 13, 0, 12, 12, 0, 1, 0, 1, 0, 6, (12, 0, 0)), 'm', 1, NPC_PARTYPERSON),
 5013: (5000, lnames[5013], ('dss', 'md', 'm', 'f', 1, 0, 3, 3, 1, 5, 1, 5, 0, 5, (12, 0, 0)), 'f', 1, NPC_PARTYPERSON),
 ...
 5129: (5139, lnames[5129], ('dll', 'md', 'm', 'f', 7, 0, 7, 7, 0, 23, 0, 23, 17, 27, (18, 0, 0)), 'f', 0, NPC_FISHERMAN),
 ...
 5229: (5245, lnames[5229], ('hss', 'ms', 's', 'f', 3, 0, 3, 3, 0, 11, 0, 11, 16, 27, (18, 0, 0)), 'f', 0, NPC_FISHERMAN),
 ...
 5322: (5318, lnames[5322], ('cls', 'ss', 'm', 'f', 10, 0, 10, 10, 0, 2, 0, 2, 11, 27, (18, 0, 0)), 'f', 0, NPC_FISHERMAN),
 ...
 9011: (9000, lnames[9011], ('csl', 'ss', 'l', 'm', 7, 0, 7, 7, 0, 8, 0, 8, 0, 4, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 ...
 9015: (9000, lnames[9015], ('rss', 'ls', 'l', 'm', 21, 0, 20, 20, 0, 12, 0, 12, 0, 11, (12, 0, 0)), 'm', 1, NPC_PARTYPERSON),
 9016: (9000, lnames[9016], ('rls', 'md', 'l', 'f', 6, 0, 21, 21, 1, 11, 1, 11, 0, 11, (12, 0, 0)), 'f', 1, NPC_PARTYPERSON),
 ...
 9136: (9153, lnames[9136], ('rll', 'ss', 'l', 'm', 17, 0, 17, 17, 1, 0, 1, 0, 1, 6, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 ...
 9215: (9744, lnames[9215], ('csl', 'ls', 'l', 'm', 31, 31, 31, 31, 0, 27, 0, 27, 0, 27), 'm', 0, NPC_REGULAR),
 ...
 9237: (9255, lnames[9237], ('dls', 'ss', 'l', 'm', 14, 0, 14, 14, 0, 7, 0, 7, 0, 10, (18, 0, 0)), 'm', 0, NPC_FISHERMAN),
 ...
 67001: (-1, lnames[67001], ('bss', 'md', 'm', 'f', 25, 0, 25, 25, 6, 12, 0, 0, 0, 2), 'f', 0, NPC_REGULAR),
 67002: (-1, lnames[67002], ('sss', 'ms', 'l', 'm', 7, 0, 7, 7, 18, 11, 0, 0, 4, 3), 'm', 0, NPC_REGULAR),
 67003: (-1, lnames[67003], ('sss', 'md', 'm', 'f', 21, 0, 21, 21, 45, 0, 0, 0, 7, 6), 'f', 0, NPC_REGULAR),
 67004: (-1, lnames[67004], ('pss', 'ls', 'l', 'm', 16, 0, 16, 16, 27, 0, 0, 0, 7, 16), 'm', 0, NPC_REGULAR),
 67005: (-1, lnames[67005], ('pls', 'ld', 's', 'f', 5, 0, 5, 5, 25, 0, 0, 0, 10, 0), 'f', 0, NPC_REGULAR),
 67006: (-1, lnames[67006], ('bll', 'ms', 's', 'm', 18, 0, 18, 18, 15, 4, 0, 0, 9, 3), 'm', 0, NPC_REGULAR),
 67007: (-1, lnames[67007], ('pls', 'ls', 's', 'm', 11, 0, 11, 11, 46, 0, 0, 0, 5, 16), 'm', 0, NPC_REGULAR),
 67008: (-1, lnames[67008], ('bls', 'ld', 's', 'f', 23, 0, 23, 23, 15, 6, 0, 0, 0, 18), 'f', 0, NPC_REGULAR),
 67009: (-1, lnames[67009], ('sll', 'ss', 's', 'm', 1, 0, 1, 1, 1, 6, 0, 0, 0, 6), 'm', 0, NPC_REGULAR),
 68001: (-1, lnames[68001], ('dss', 'ms', 'm', 'm', 19, 0, 19, 19, 2, 27, 2, 27, 0, 27, (18, 0, 0)), 'm', 0, NPC_LONELY_LOUIS)
}
try:
...
HQnpcFriends = {2001: (ToontownBattleGlobals.HEAL_TRACK,
 ...
 1329: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        ...
        3)}
FOnpcFriends = {
 20002: (ToontownBattleGlobals.NPC_RESTOCK_GAGS, -1, 0, 5),
