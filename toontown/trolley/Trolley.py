...
class Trolley(StateData.StateData):
    ...
    def enableExitButton(self):
        self.exitButton = ToontownButton(relief=None, text=TTLocalizer.FishingExit, text_fg=(1, 1, 0.65, 1), text_pos=(0, -0.23), text_scale=TTLocalizer.TexitButton, image=(self.upButton, self.downButton, self.rolloverButton), image_color=(1, 0, 0, 1), image_scale=(10, 1, 11), pos=(0, 0, -0.8), scale=0.18, command=lambda self = self: self.fsm.request('requestExit'))
