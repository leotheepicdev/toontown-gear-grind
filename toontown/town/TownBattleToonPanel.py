...
class TownBattleToonPanel(DirectFrame):
    ...
    def __init__(self, id):
        ...
        self.fireText.hide()
        self.tauntText = DirectLabel(parent=self, relief=None, pos=(0.1, 0, 0.015), text=TTLocalizer.TownBattleToonTaunt, text_scale=0.06)
        self.tauntText.hide()
        self.sueText = DirectLabel(parent=self, relief=None, pos=(0.1, 0, 0.015), text=TTLocalizer.TownBattleToonSue, text_scale=0.06)
        self.sueText.hide()
