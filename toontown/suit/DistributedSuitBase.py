...
class DistributedSuitBase(DistributedAvatar.DistributedAvatar, Suit.Suit, SuitBase.SuitBase):
    ...
    def setVirtual(self, virtual):
        ...
        if virtual > 0:
            Suit.Suit.makeVirtual(self, virtual)
        if virtual == 2:
            self.maxHP *= 2
            self.currHP *= 2
    ...
    def setSkeleRevives(self, num):
        ...
        if self.getSkeleRevives() > 0:
            ...
            if self.dna.dept not in ['c', 'l', 's', 'm']:
    ...
    def attachPropeller(self):
        ...
        propellerSfxChoice = random.randint(1, 2)

        if self.propInSound == None:
            self.propInSound = base.loader.loadSfx('phase_5/audio/sfx/ENC_propeller_in_%s.ogg' % propellerSfxChoice)
        if self.propOutSound == None:
            self.propOutSound = base.loader.loadSfx('phase_5/audio/sfx/ENC_propeller_out_%s.ogg' % propellerSfxChoice)
    ...
    def setSkelecog(self, flag):
        ...
        if flag:
            Suit.Suit.makeSkeleton(self, flag)
