from panda3d.core import BitMask32, CollideMask, CollisionNode, CollisionPlane, CollisionPolygon, CollisionTube, Geom, GeomNode, GeomTriangles, GeomVertexData, GeomVertexFormat, GeomVertexWriter, NodePath, Plane, Point3, TextNode, VBase3, VBase4, Vec3, headsUp, lookAt
...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def __talkAboutPromotion(self, speech):
        ...
        if base.localAvatar.doId == self.mvp:
            speech += TTLocalizer.WitnessToonMVP
        return speech
