...
class ToontownChatManager(ChatManager.ChatManager):
    ...
    def sendSCGreetingChatMessage(self, textId):
        messenger.send('chatUpdateSCGreeting', [textId])
    ...
    def __clButtonPressed(self):
        ...
        if base.localAvatar.chatLog:
            if base.localAvatar.chatLog.isHidden():
                base.localAvatar.chatLog.show()
            else:
                base.localAvatar.chatLog.hide()
