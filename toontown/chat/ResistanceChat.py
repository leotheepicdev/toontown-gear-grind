...
rewardResistanceMenu = [RESISTANCE_TOONUP, RESISTANCE_RESTOCK, RESISTANCE_MONEY]
...
def getRandomId():
    menuIndex = random.choice(rewardResistanceMenu)
