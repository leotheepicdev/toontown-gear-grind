...
class FriendsListManager:
    ...
    def enterFLM(self, battle=False):
        ...
        if battle:
            base.localAvatar.handleBattleFriendsList()
        else:
    ...
    def exitFLM(self, battle=False):
        ...
        if battle:
            base.localAvatar.handleBattleExit()
        if self.avatarPanel:
