...
class ClothesGUI(StateData.StateData):
    ...
    def __init__(self, type, doneEvent, swapEvent = None):
        ...
        self.girlInShorts = 0
        self.swappedTorso = 0
        self.tailorId = ToonDNA.MAKE_A_TOON
    ...
    def load(self):
        ...
        self.shirtStyleFrame = DirectFrame(parent=self.parentFrame, image=shuffleFrame, image_scale=halfButtonInvertScale, relief=None, pos=(0, 0, 0.125), hpr=(0, 0, 3), scale=1.2, frameColor=(1, 1, 1, 1), text=TTLocalizer.ClothesShopShirtsStyle, text_scale=0.0575, text_pos=(-0.001, -0.015), text_fg=(1, 1, 1, 1))
        ...
        self.shirtFrame = DirectFrame(parent=self.parentFrame, image=shuffleFrame, image_scale=halfButtonInvertScale, relief=None, pos=(0, 0, -0.12), hpr=(0, 0, 3), scale=1.2, frameColor=(1, 1, 1, 1), text= TTLocalizer.ClothesShopShirtsColor, text_scale=0.0575, text_pos=(-0.001, -0.015), text_fg=(1, 1, 1, 1))
        self.topLButton = DirectButton(parent=self.shirtFrame, relief=None, image=(shuffleArrowUp,
         shuffleArrowDown,
         shuffleArrowRollover,
        ...
        self.bottomStyleFrame = DirectFrame(parent=self.parentFrame, image=shuffleFrame, image_scale=halfButtonInvertScale, relief=None, pos=(0, 0, -0.35), hpr=(0, 0, -2), scale=1.2, frameColor=(1, 1, 1, 1), text='', text_scale=0.055, text_pos=(-0.001, -0.015), text_fg=(1, 1, 1, 1))
        ...
        self.bottomFrame = DirectFrame(parent=self.parentFrame, image=shuffleFrame, image_scale=halfButtonInvertScale, relief=None, pos=(0, 0, -0.6), hpr=(0, 0, -2), scale=1.2, frameColor=(1, 1, 1, 1), text='', text_scale=0.055, text_pos=(-0.001, -0.015), text_fg=(1, 1, 1, 1))
        self.bottomLButton = DirectButton(parent=self.bottomFrame, relief=None, image=(shuffleArrowUp,
         shuffleArrowDown,
         shuffleArrowRollover,
    ...
    def setupButtons(self):
        ...
        if self.type == CLOTHES_CLOSET:            
            ...
            if ToonDNA.Shorts[botTex][1] == ToonDNA.SHORTS:
                self.girlInShorts = 1
        else:
    ...
    def swapTopStyle(self, offset):
        ...
        colors = ToonDNA.getTopColors(self.gender, self.topStyles[self.topStyleChoice], tailorId=self.tailorId)
    ...
    def swapBottomStyle(self, offset):
        ...
        colors = ToonDNA.getBottomColors(self.gender, self.bottomStyles[self.bottomStyleChoice], tailorId=self.tailorId)
        colorLength = len(colors)
