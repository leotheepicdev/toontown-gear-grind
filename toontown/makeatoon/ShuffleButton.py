...
class ShuffleButton:
    ...
    def load(self):
        ...
        self.shuffleBtn = ToontownButton(parent=self.parentFrame, anim='stretch', relief=None, image=(shuffleUp, shuffleDown, shuffleUp), image_scale=halfButtonInvertScale, image1_scale=(-0.63, 0.6, 0.6), image2_scale=(-0.63, 0.6, 0.6), text=(TTLocalizer.ShuffleButton,
        ...
        self.incBtn = ToontownButton(parent=self.parentFrame, relief=None, image=(shuffleArrowUp,
         shuffleArrowDown,
         shuffleArrowUp,
        ...
        self.incBtn.hide()
        self.decBtn = ToontownButton(parent=self.parentFrame, relief=None, image=(shuffleArrowUp,
         shuffleArrowDown,
         shuffleArrowUp,
