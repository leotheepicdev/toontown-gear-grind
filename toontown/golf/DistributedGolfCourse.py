...
class DistributedGolfCourse(DistributedObject.DistributedObject, FSM, DelayDeletable):
    ...
    def setJellybeanReward(self, jellybeanReward):
    ...
    def enterWaitReward(self):
        ...
        self.golfRewardDialog = GolfRewardDialog.GolfRewardDialog(self.avIdList, self.trophiesList, self.rankingsList, self.holeBestList, self.courseBestList, self.cupList, self.localAvId, self.tieBreakWinner, self.aimTimesList, self.jellybeanReward)
