...
class GolfRewardDialog:
    ...
    def __init__(self, avIdList, trophyList, rankingsList, holeBestList, courseBestList, cupList, localAvId, tieBreakWinner, aimTimesList, jellybeanReward=0, endMovieCallback = None):
        ...
        self.jellybeanReward = jellybeanReward
    ...
    def setup(self, localAvId):
        ...
        self.rewardJar = DirectLabel(parent=base.a2dBottomLeft, relief=None, pos=(0.25, 0, 0.25), color=(1, 1, 1, 1), scale=0.75, text='+%s' % self.jellybeanReward, 
