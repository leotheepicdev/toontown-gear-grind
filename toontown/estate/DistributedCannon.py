from panda3d.core import BitMask32, CollideMask, CollisionHandler, CollisionHandlerEvent, CollisionHandlerFloor, CollisionNode, CollisionPolygon, CollisionRay, CollisionSphere, Geom, GeomNode, GeomTriangles, GeomVertexData, GeomVertexFormat, GeomVertexWriter, NodePath, PandaNode, Point3, Vec3, Vec4, lookAt
...
from lib.libotp.NametagFloat3d import NametagFloat3d
from lib.libotp.Nametag import Nametag
...
class DistributedCannon(DistributedObject.DistributedObject):
    ...
    def load(self):
        ...
        self.sndHitHouse = base.loader.loadSfx('phase_5/audio/sfx/AA_drop_sandbag_short.ogg')
