...
class DistributedClosetAI(DistributedFurnitureItemAI):
    ...
    def __handleClosetTimeout(self, avId):
        ...
        self.d_setState(ClosetGlobals.CLOSED, avId, self.ownerId, self.topList, self.bottomList)

    def d_setState(self, mode, avId, ownerId, topList, bottomList):
        self.sendUpdate('setState', [mode, avId, ownerId, topList, bottomList])
    ...
    def setDNA(self, dnaString, finished, whichItems):
        ...
        if finished == 1:
            ...
            self.d_setState(ClosetGlobals.CLOSED, 0, self.ownerId, self.topList, self.bottomList)
        else:
            if finished == 2:
