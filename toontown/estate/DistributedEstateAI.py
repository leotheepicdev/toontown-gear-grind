...
# from toontown.estate.DistributedHotTubAI import DistributedHotTubAI
...
class DistributedEstateAI(DistributedObjectAI):
    ...
    def announceGenerate(self):
        ...
        self.fisherman = NPCToons.createNPC(self.air, 68001, NPCToons.NPCToonDict[68001], self.zoneId)
        ...
        # Generate our Hot Tub:
        # self.hotTub = DistributedHotTubAI(self.air)
        # self.hotTub.setPos(0, 0, 0)
        # self.hotTub.generateWithRequired(self.zoneId)
