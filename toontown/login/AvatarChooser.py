...
POSITIONS = (Vec3(-0.840167, 0, 0.359333),
 Vec3(0.00933349, 0, 0.359333),
 Vec3(0.862, 0, 0.359333),
 Vec3(-0.840167, 0, -0.445659),
 Vec3(0.00933349, 0, -0.445659),
 Vec3(0.862, 0, -0.445659))
...
class AvatarChooser(StateData.StateData):
    ...
    def enter(self):
        ...
        base.setBackgroundColor(Vec4(0.98823529411, 0.34901960784, 0.1725490196, 1))
        ...
        base.updateDistrict('Pick A Toon')
    ...
    def load(self, isPaid):
        ...
        self.pickAToonBG = newGui.find('**/pickAToon/**/bg')
        self.pickAToonBG.reparentTo(hidden)
        ...
        self.quitButton = ToontownButton(image=(gui.find('**/QuitBtn_UP'), gui.find('**/QuitBtn_DN'), gui.find('**/QuitBtn_RLVR')), anim='stretch', relief=None, text=TTLocalizer.AvatarChooserQuit, text_font=ToontownGlobals.getSignFont(), text0_fg=(0.152, 0.75, 0.258, 1), text1_fg=(0.152, 0.75, 0.258, 1), text2_fg=(0.977, 0.816, 0.133, 1), text_pos=TTLocalizer.ACquitButtonPos, text_scale=TTLocalizer.ACquitButton, image_scale=1, image1_scale=1.05, image2_scale=1.05, scale=1.05, parent=base.a2dBottomCenter, pos=(0, 0, 0.08), command=self.__handleQuit)
        self.logoutButton = ToontownButton(relief=None, anim='stretch', image=(gui.find('**/QuitBtn_UP'), gui.find('**/QuitBtn_DN'), gui.find('**/QuitBtn_RLVR')), text=TTLocalizer.OptionsPageLogout, text_font=ToontownGlobals.getSignFont(), text0_fg=(0.152, 0.75, 0.258, 1), text1_fg=(0.152, 0.75, 0.258, 1), text2_fg=(0.977, 0.816, 0.133, 1), text_scale=TTLocalizer.AClogoutButton, text_pos=(0, -0.035), parent=base.a2dBottomRight, pos=(-0.2, 0, 0.076), image_scale=1.15, image1_scale=1.15, image2_scale=1.18, scale=0.5, command=self.__handleLogoutWithoutConfirm)
        self.logoutButton.hide()
        gui.removeNode()
        gui2.removeNode()
        newGui.removeNode()
    ...
    def __handleLogoutWithoutConfirm(self):
        base.cr.connectingBox = TTDialog.TTDialog(text=TTLocalizer.AvatarChooserLoggingOut, style=TTDialog.NoButtons)
        base.cr.connectingBox.show()
        base.cr.clientManager.logout()
