...
class PartyCogTrackerGui:
    ...
    def __init__(self):
        ...
        self.cogTracker.reparentTo(base.a2dBottomRight)
        self.cogTracker.setScale(1.25)
        self.cogTracker.setX(-0.333333)
        self.cogTracker.setZ(0.25)
...
class PartyCogActivityGui(DirectObject):
    ...
    def _initControlGui(self):
        ...
        self._moveKeys.reparentTo(base.a2dBottomRight)
        self._moveKeys.setPos(-0.333333, 0.0, 0.565)
        self._moveKeys.setScale(0.15)
        self._attackKeys.reparentTo(base.a2dBottomRight)
        self._attackKeys.setPos(-0.483333, 0.0, 0.55)
    ...
    def _initScore(self):
        self._scoreLabel = OnscreenText(text='0', parent=base.a2dBottomRight, pos=PartyGlobals.CogActivityScorePos, scale=PartyGlobals.TugOfWarTextWordScale, fg=(1.0, 1.0, 0.0, 1.0), align=TextNode.ARight, font=ToontownGlobals.getSignFont(), mayChange=True)
        self._scoreTitle = OnscreenText(text=TTLocalizer.PartyCogGuiScoreLabel, parent=base.a2dBottomRight, pos=PartyGlobals.CogActivityScoreTitle, scale=0.05, fg=(1.0, 1.0, 1.0, 1.0), align=TextNode.ARight)
