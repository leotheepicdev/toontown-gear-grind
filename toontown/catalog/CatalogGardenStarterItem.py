...
class CatalogGardenStarterItem(CatalogItem.CatalogItem):
    ...
    def reachedPurchaseLimit(self, avatar):
        if avatar.onOrder.count(self) != 0 or avatar.onGiftOrder.count(self) != 0 or avatar.mailboxContents.count(self) != 0 or self in avatar.awardMailboxContents or self in avatar.onAwardOrder or hasattr(avatar, 'gardenStarted') and avatar.getGardenStarted():
            return 1
        return 0
