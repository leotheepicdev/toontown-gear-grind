...
from .CatalogRewriteItem import CatalogRewriteItem
from .CatalogRenameItem import CatalogRenameItem
from .CatalogHousePaintItem import CatalogHousePaintItem
from .CatalogSkipItem import CatalogSkipItem
...
MetaItems = {100: getAllClothes(101, 102, 103, 104, 105, 106, 107, 108, 109, 109, 111, 115, 206, 207, 209, 209, 211, 215),
 300: getAllClothes(301, 302, 303, 304, 305, 308, 401, 403, 404, 405, 407, 452),
...
MonthlySchedule = ((7,
 ...
 (1,
  ...
  (CatalogGardenItem(100, 1),
   ...
   CatalogNametagItem(19),
   CatalogNametagItem(20),
   CatalogNametagItem(21),
   CatalogNametagItem(22),
   CatalogRewriteItem(),
   CatalogRenameItem(),
   CatalogHousePaintItem(0),
   CatalogHousePaintItem(1),
   CatalogHousePaintItem(2),
   CatalogHousePaintItem(3),
   CatalogHousePaintItem(4),
   CatalogHousePaintItem(5),
   CatalogHousePaintItem(6),
   CatalogHousePaintItem(7),
   CatalogHousePaintItem(8),
   CatalogSkipItem())),
 (5,
  26,
  6,
