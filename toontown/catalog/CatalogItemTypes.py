...
from . import CatalogRewriteItem
from . import CatalogRenameItem
from . import CatalogSkipItem
from . import CatalogHousePaintItem
INVALID_ITEM = 0
FURNITURE_ITEM = 1
CHAT_ITEM = 2
CLOTHING_ITEM = 3
...
CatalogItemTypes = {CatalogInvalidItem.CatalogInvalidItem: INVALID_ITEM,
 ...
 CatalogRewriteItem.CatalogRewriteItem: REWRITE_ITEM,
 CatalogRenameItem.CatalogRenameItem: RENAME_ITEM,
 CatalogSkipItem.CatalogSkipItem: CATALOG_SKIP_ITEM,
 CatalogHousePaintItem.CatalogHousePaintItem: HOUSE_PAINT_ITEM}
CatalogItemType2multipleAllowed = {INVALID_ITEM: False,
 ...
 REWRITE_ITEM: False,
 RENAME_ITEM: False,
 CATALOG_SKIP_ITEM: False,
 HOUSE_PAINT_ITEM: False}
