...
colors = {WHITE: Vec4(1, 1, 1, 1),
 ...
 CYAN: Vec4(0.2, 1, 1, 1)}
textures = {SNOWFLAKE: 'phase_4/models/props/tbTreasure',
 MUSICNOTE: 'phase_4/models/props/mmlTreasure',
 FLOWER: 'phase_4/models/props/dgTreasure',
 ICECREAM: 'phase_4/models/props/ttcTreasure',
 STARFISH: 'phase_4/models/props/ddTreasure',
 ZZZ: 'phase_4/models/props/ddlTreasure'}
fireworkId = 0
...
def getTexture(textureIndex):
    if treasureIndex == MUSICNOTE:
        return loader.loadModel(textures.get(textureIndex)).find('note%s' % str(random.randint(1, 3)))
    elif treasureIndex == SNOWFLAKE:
        return loader.loadModel(textures.get(textureIndex)).find('flake%s' % str(random.randint(1, 3)))
