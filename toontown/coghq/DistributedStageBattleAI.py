...
from toontown.toonbase.ToontownBattleGlobals import getStageJuryNoticeMultiplier
    ...
    def handleToonsWon(self, toons):
        ...
        for floorNum, cogsThisFloor in enumerate(self.suitsKilledPerFloor):
            ...
            for toon in toons:
                ...
                meritArray = self.air.promotionMgr.recoverMerits(toon, cogsThisFloor, self.getTaskZoneId(), getStageJuryNoticeMultiplier(floorNum), respectInvasions=False)
