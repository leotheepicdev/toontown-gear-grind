...
from toontown.toonbase.ToontownBattleGlobals import getCountryClubStockOptionMultiplier
...
class DistributedCountryClubBattleAI(DistributedLevelBattleAI.DistributedLevelBattleAI):
    ...
    def handleToonsWon(self, toons):
        ...
        for toon in toons:
            ...
            meritArray = self.air.promotionMgr.recoverMerits(toon, self.suitsKilled, self.getTaskZoneId(), getCountryClubStockOptionMultiplier(self.getTaskZoneId()), extraMerits=extraMerits, respectInvasions=False)
