...
from toontown.toonbase.ToontownBattleGlobals import getMintCogbucksMultiplier
...
class DistributedMintBattleAI(DistributedLevelBattleAI.DistributedLevelBattleAI):
    ...
    def handleToonsWon(self, toons):
        ...
        for toon in toons:
            ...
            meritArray = self.air.promotionMgr.recoverMerits(toon, self.suitsKilled, self.getTaskZoneId(), getMintCogbucksMultiplier(self.getTaskZoneId()), extraMerits=extraMerits, respectInvasions=False)
