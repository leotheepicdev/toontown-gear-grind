...
class SellbotCogHQLoader(CogHQLoader.CogHQLoader):
    ...
    def __init__(self, hood, parentFSMState, doneEvent):
        ...
        self.fsm.addState(State.State('factoryExterior', self.enterFactoryExterior, self.exitFactoryExterior, ['quietZone', 'factoryInterior', 'cogTowerInterior', 'cogHQExterior']))
        ...
        self.fsm.addState(State.State('cogTowerInterior', self.enterCogTowerInterior, self.exitCogTowerInterior, ['quietZone', 'factoryExterior']))
        for stateName in ['quietZone']:
            state = self.fsm.getStateNamed(stateName)
            state.addTransition('factoryInterior')
            state.addTransition('cogTowerInterior')
    ...
    def enterCogTowerInterior(self, requestStatus):
        self.placeClass = CogTowerInterior.CogTowerInterior
        self.enterPlace(requestStatus)
