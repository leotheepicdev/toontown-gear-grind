...
AvPropDamage = ((((8, 10), (Levels[0][0], Levels[0][1])),
  ...
  ((80, 90), (Levels[0][5], Levels[0][6])),
  ((120, 120), (Levels[0][6], MaxSkill))),
...
def getMintCogbucksMultiplier(mintId):
...
def getStageJuryNoticeMultiplier(floor):
...
def getCountryClubStockOptionMultiplier(countryClubId):
