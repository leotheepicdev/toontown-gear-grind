...
NametagFonts = ('phase_3/models/fonts/AnimGothic',
 ...
 'phase_3/models/fonts/TooneyNoodle.bam',
 'phase_3/models/fonts/Prankster_JNL.ttf',
 'phase_3/models/fonts/PBN.ttf',
 'phase_3/models/fonts/SF_Toontime.ttf',
...
GlobalStreetNames = {20000: ('to', 'on', 'Tutorial Terrace'),
 ...
 2400: ('to', 'on', "Tutorial Tom's Tutorial Terrace"),
 ...
 7100: ('to', 'on', 'Rodeo Road'),
 7200: ('to', 'on', 'Cactus Court'),
 7300: ('to', 'on', 'High Noon Nook'),
...
ResistanceRangerHideout = ('to the', 'in the', 'Resistance Ranger Hideout')
Factory = 'Factory'
...
QuestsTomBuildingQuestBuilding = "Tutorial Tom's Cog Building"
QuestsTomBuildingQuestBuildings = 'Tutorial Tom Cog Buildings'
QuestsTomBuildingQuestHeadline = 'DEFEAT'
QuestsTomBuildingQuestProgressString = '%(progress)s of %(num)s defeated'
QuestsTomBuildingQuestString = 'Defeat %s'
QuestsTomBuildingQuestSCString = 'I need to defeat %(objective)s.'
QuestsTomBuildingQuestDescS = "Tutorial Tom's Cog Building"
QuestsTomBuildingQuestDescP = '%{count}s Tutorial Tom Cog Buildings'
...
QuestsClothingTicketReward = 'You have obtained a Clothing Ticket.\x07Head to a Mercantile located in a playground to use it.'
QuestsClothingTicketRewardPoster = 'Reward: Clothing Ticket'
QuestsGloveTicketReward = 'You have obtained a Glove Ticket.\x07Head to the Toontown Glove Factory located on Loopy Lane to use a Glove Ticket.'
QuestsGloveTicketRewardPoster = 'Reward: Glove Ticket'
...
QuestsItemDict = {1: ['Pair of Glasses', 'Pairs of Glasses', 'a '],
 2: ['Key', 'Keys', 'a '],
 3: ['Adding Machines', 'Adding Machines', 'some '],
 4: ['Book', 'Books', 'a '],
 5: ['Candy Bar', 'Candy Bars', 'a '],
 6: ['Piece of Chalk', 'Pieces of Chalk', 'a '],
 7: ['Noisemaker Supplies', 'Noisemaker Supplies', 'some '],
 8: ['Noisemakers', 'Noisemakers', 'some '],
 9: ['Adding machine', 'Adding machines', 'an '],
 10: ['Clown car tire', 'Clown car tires', 'a '],
 11: ['Air pump', 'Air pumps', 'an '],
 12: ['Spaghetti', 'Spaghettis', 'some '],
 13: ['Package', 'Package', 'a '],
 14: ['Teacup', 'Teacups', 'a '],
 15: ['Feather', 'Feathers', 'a '],
 18: ['Fake Goldfish', 'Fake Goldfish', 'some '],
 19: ['Sea Sprinkles', 'Sea Sprinkles', 'some '],
 20: ['Blackboard Eraser', 'Blackboard Erasers', 'a '],
 21: ['Joke', 'Jokes', 'a '],
 22: ['Double Decker', 'Double Deckers', 'a '],
 23: ['Eraser', 'Erasers', 'a '],
 24: ['Memo', 'Memos', 'a '],
 25: ['Goofball', 'Goofballs', 'a '],
 26: ['Coal', 'Coals', 'some '],
 ...
 4012: ['Data', 'Data', 'some '],
 4013: ['Piece of Gold', 'Pieces of Gold', 'a '],
 4014: ['Bags of Money', 'Bags of Money', 'some '],
 4015: ['Flour', 'Flour', 'some '],
 4016: ['Stick of Butter', 'Sticks of Butter', 'a '],
 4017: ['Milk', 'Milk', 'some '],
 4018: ['Pancakes', 'Pancakes', 'some '],
 4019: ['Coda Pop', 'Coda Pop', 'some '],
 4020: ['Tire', 'Tires', 'a '],
 4021: ['Common Time Watch', 'Common Time Watches', 'a '],
 4022: ['Stainless Steel', 'Stainless Steel', 'some '],
 4023: ['Stainless Steel Watch', 'Stainless Steel Watch', 'a '],
 4024: ['Gift Box' 'Gift Boxes', 'a '],
 4025: ['Tuxedo', 'Tuxedos', 'a '],
 4026: ['CD', 'CDs', 'a '],
 4027: ['Jar of Jellybeans', 'Jars of Jellybeans', 'a '],
 ...
 5018: ['Script', 'Script', 'a '],
 5019: ['Key to Sellbot HQ', 'Keys to Sellbot HQ', 'a '],
 ...
 3028: ['Lawbot HQ Legal Papers', 'Lawbot HQ Legal Papers', 'some '],
 3029: ['Bell', 'Bells', 'a '],
 6001: ['Bossbot HQ Plans', 'Bossbot HQ Plans', 'some '],
 6002: ['Rod', 'Rods', 'a '],
 ...
 7015: ['Whey', 'Whey', 'some '],
 7016: ['Way to Bossbot HQ', 'Way to Bossbot HQ', 'the']}
...
QuestDialogDict = {
 ...
 121: {QUEST: "Thanks for the candy bar!\x07Now that you're here, if you help me with something, you'll get a reward.\x07The Cogs stole the key to my safe, and now I can't access my jellybeans!\x07Please find the key for me from the Cogs."},
 ...
 131: {QUEST: "Oh, thanks for the chalk.\x07What?!?\x07The Cogs stole my blackboard, and now I can't teach!\x07Please find the blackboard for me from the Cogs!"},
 ...
 141: {QUEST: 'Oh, yes, this book almost completes my collection.\x07Let me see...\x07Uh oh...\x07Now where did I put my glasses?\x07I had them just before the Cogs took over my building.\x07Please get my glasses from the Cogs!'},
 142: {QUEST: 'Thank you so much!\x07I think you will be a great help to everyone around here.\x07By the way, I just received a message from Toon HQ.\x07They forgot to mention a few important concepts.\x07Head down there when you can.',
 ...
 401: {GREETING: '',
       ...
       LEAVING: QuestsDefaultLeaving},
 1039: {QUEST: 'Uh oh, looks like _toNpcName_ has a boo boo.\x07Give her a hand with all of the care she needs._where_'},
 1040: {QUEST: "Those boring Cogs haven't been taking my funny jokes.\x07My funnies have blown into smoke.\x07I may be Foo Foo, but I need help from Boo Boo._where_",
        LEAVING: ''},
 1041: {QUEST: 'Foo Foo has a boo boo?\x07I may not be a real doctor, but I can solve it.\x07A couple of jokes here and there will do the trick.\x07The Cogs might be carrying around her jokes.\x07Defeat a few, and then return them to Foo Foo._where_',
        INCOMPLETE_PROGRESS: 'Have you found her jokes yet?',
        COMPLETE: "Yippee!\x07You've made me quite hoppy.\x07My buns are already coming back.\x07Say, this will make you very eggcited."},
 1042: {QUEST: '_toNpcName_ has been a bit too kind with her tea.\x07Stop by and give her some help._where_'},
 1043: {QUEST: "A Yesman stopped by my shop, and I offered it a cup of Tee-Hee Tea.\x07The Cog took the offer, but walked off without my tea cup!\x07I think he may still be around here.\x07Please go get my teacup back.",
        INCOMPLETE_PROGRESS: 'Did you find my teacup yet?',
        COMPLETE: 'Woo hoo!\x07The cup is in great condition.\x07Here, drink some of my special Tee-Hee Tea.'},
 1044: {QUEST: 'I heard _toNpcName_ wants someone to enjoy his explosions._where_'},
 1045: {QUEST: 'Howdy - welcome to The Kaboomery.\x07We sure love exploding Cogs here.\x07You should give it a try.\x07Stronger Cogs give off the perfect kaboom!',
        INCOMPLETE_PROGRESS: "Looks like you haven't had enough fun yet.",
        LEAVING: '',
        GREETING: '',
        COMPLETE: "Looks like your face has exploded with tons of fun!\x07Say, the more those Cogs blow up, the sillier you get!\x07It seems like you've already blown up with laughter.\x07You've earned it, Toon."},
 1046: {QUEST: '_toNpcName_ has been bugging the Toon HQ.\x07Sadly, he is known for being a little too wacky.\x07Please help the guy out._where_'},
 1047: {QUEST: "Oh, there you are!\x07I've gone hungry, and no one has been helping me.\x07I don't have time to pick up food because I play League of Toons all day.\x07Hey - you know what.\x07I heard Laughter Hours Cafe makes a mean double decker.\x07Yeah, go get me some food from there._where_",
        INCOMPLETE_PROGRESS: "Listen, I'm hungry. Where is my food, Toon?"},
 1048: {QUEST: 'What do you need?\x07A double decker?\x07Sorry, but the last one was stolen by a Double Talker.\x07I think it is still around here somewhere.\x07If you find it, there is no need to come back here.\x07It is all free of charge.'},
 1049: {QUEST: "Thanks for the meal.\x07It looks delicious.\x07Hey, where is my drink?\x07They forgot the drink...\x07I could go for a Mountain Tew from Fizzy Lizzy right now.\x07Huh?\x07What do you mean The Brrrgh is far away?\x07Fine, go get me a glass of water, and then I'll be good to go.",
        COMPLETE: "About time.\x07Say, that pouch of yours looks small.\x07Recently I've upgraded my pouch, so you can have my old one.",
        LEAVING: ''},
 1050: {QUEST: '_toNpcName_ needs help holding a seminar all about the Cogs._where_'},
 1051: {QUEST: "You may have heard that I am holding a seminar all about the Cogs.\x07For one of my demonstrations, I need some Cog Gears.\x07Not just any Cog Gears though.\x07I need one from a high level Cog.",
        INCOMPLETE_PROGRESS: 'Have you found some Cog Gears yet?'},
 1052: {QUEST: 'Thanks for getting my materials ready.\x07Say, I am really hungry right now.\x07I could go for a Fruit Pie Slice.\x07Please deliver a Fruit Pie Slice to me.',
        COMPLETE: "Mmm... looks delicious.\x07Thanks a lot for the help.\x07I know you didn't come for my seminar, so take this instead.",
        GREETING: ''},
 1053: {QUEST: '_toNpcName_ has been making a fuss about his spaghetti.\x07You need to hurry over there in fretta._where_'},
 1054: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Ay, where is my spaghetti?',
        QUEST: "Ciao, _avName_.\x07The Bottom Feedas have stolen my spaghetti.\x07It ain't an all-you-can-eat meal at the garden y'know?\x07I need you to get my spaghetti back.\x07I have a lot of customers to serve!"},
 1055: {GREETING: '',
        QUEST: 'Looks like some of has been eaten.\x07Leave it between you and me, but I am going to serve it anyway.\x07Say, I ate all of the goofballs while you were gone.\x07I am going to need you to fish them up for me.\x07Goofballs can only be found on this street.',
        COMPLETE: 'Mangia, _avName_!\x07You could use some of my special Spaghetti & Goofballs too.'},
 1056: {QUEST: '_toNpcName_ is having trouble with serving her ice cream.\x07Drop by and see what she needs help with._where_'},
 1057: {QUEST: 'Oh, thank you for stopping by!\x07The Cogs have stolen my ice cream cones.\x07Please find them as soon as possible.',
        INCOMPLETE_PROGRESS: 'Have you found my ice cream cones yet?'},
 1058: {QUEST: 'That will do!\x07Wait a second...\x07I am out of Sea Sprinkles!\x07I usually find them at the fishing pond nearby, so please go get some.',
        COMPLETE: 'Wowza!\x07These ones look tasty.\x07They will pair well with my sundaes.\x07Here, have one of my delicious sundaes!',
        GREETING: '',
        LEAVING: ''},
 1059: {QUEST: '_toNpcName_ has some breaking news to report!\x07Check out the buzz._where_'},
 1060: {QUEST: 'You are just in time!\x07A new report has just been delivered.\x07I heard this story is a shocking one.\x07Hold on...\x07The writing is all scribbles!\x07Perhaps you can grab a few memos from some Sellbots.',
        GREETING: ''},
 1061: {QUEST: 'You are just in time!\x07A new report has just been delivered.\x07I heard this story is a shocking one.\x07Hold on...\x07The writing is all scribbles!\x07Perhaps you can grab a few memos from some Cashbots.',
        GREETING: ''},
 1062: {QUEST: 'You are just in time!\x07A new report has just been delivered.\x07I heard this story is a shocking one.\x07Hold on...\x07The writing is all scribbles!\x07Perhaps you can grab a few memos from some Lawbots.',
        GREETING: ''},
 1063: {QUEST: 'You are just in time!\x07A new report has just been delivered.\x07I heard this story is a shocking one.\x07Hold on...\x07The writing is all scribbles!\x07Perhaps you can grab a few memos from some Bossbots.',
        GREETING: ''},
 1064: {QUEST: "Now, let's see what we have here.\x07Oh, this is quite the shocker.\x07The Cogs have recently approved plans to construct their buildings on top of ours.\x07This is some real bad news for us.\x07According to the memos, these new buildings contain new employees who work nonstop.\x07This is worthy of some investigating.\x07Let's call these things \"Cog Buildings\".\x07Please enter one of these Cog Buildings, and report back.",
        INCOMPLETE_PROGRESS: 'Do you have any new information on the Cog Buildings?',
        COMPLETE: 'So, what did you learn?\x07Strange interiors?\x07A lot of Cogs?\x07Undocumented Cogs?\x07That is interesting.\x07From here, I will be writing a report on all of this newly gathered information.\x07You have been a big asset.\x07Here is a big reward for your help.',
        GREETING: '',
        LEAVING: ''},
 1065: {QUEST: 'Tony Maroni has been having trouble with Telemarketers.\x07Talk a walk over there, and see what you can do._where_'},
 1066: {QUEST: 'Oh my galoshes!\x07Those pesky Telemarketers have been calling my shop all day!\x07Please wipe some of them out from the streets.\x07That should do the job for now.',
        INCOMPLETE_PROGRESS: 'Are the pests gone?'},
 1067: {QUEST: 'Great!\x07That will make my business much easier.\x07Listen, I recently thought of the best prank ever.\x07Maybe we should send Sharky Jones some fake goldfish!\x07That will give him and I a real laugh!\x07Please fish up some fake goldfish, and then send it over to the 14 Karat Goldfish shop in Loopy Lane.',
        INCOMPLETE_PROGRESS: 'Remember, Sharky Jones is located at the 14 Karat Goldfish shop in Loopy Lane.',
        INCOMPLETE_WRONG_NPC: 'Sharky Jones is located at the 14 Karat Goldfish shop in Loopy Lane.'},
 1068: {QUEST: "What's this?\x07Some goldfish?\x07I've recently lost some, so this is a great surprise.\x07Who is this from?\x07Tony Maroni?\x07Tell him I give him my thanks.",
        GREETING: '',
        LEAVING: '',
        COMPLETE: 'Did he accept them?\x07Haha, he fell for it!\x07Thank you for making my day easier.\x07Say, I have an extra ToonTask that you can carry around.\x07Trust me, there is no foolery here!'},
 1069: {QUEST: 'The Cashbots have been causing trouble at the Funny Money Savings and Loan shop.\x07Stop by there and see if there is anything you can do.'},
 1070: {QUEST: 'Cashbots have been sneaking into the bank and stealing our machines.\x07Please recover 10 adding machines from Cashbots.\x07To save you from running back and forth, just bring them all back at once.',
        INCOMPLETE_PROGRESS: 'Where are my machines?'},
 1071: {QUEST: "Wow!  Thanks for finding our adding machines.'\x07Hm...\x07They look a little dusty\x07Say, could you take them over to _toNpcName_ over at her shop, \"Tickle Machines\" on this street? See if she can clean them."},
 1072: {QUEST: "What's that?\x07Dusty adding machines?\x07Cashbots you say?\x07Well, let's have a look see...\x07Yep, that is dirty all right.\x07It needs a little dusting but I have no feathers.\x07I'll need five feathers from the local fishing pond.\x07A lot of ducks tend to leave some there.\x07Bring them back at once, and I'll clean the machines up!",
        INCOMPLETE_PROGRESS: 'Any luck finding some feathers?'},
 1073: {QUEST: "Ah yes, that should do the trick.\x07All fixed now, free of charge.\x07Take these back to Funny Money, and tell 'im I said howdy.",
        COMPLETE: "Adding machines all cleaned up?\x07Nice work.\x07I'm sure I've got something around here to reward you with...",
        GREETING: ''},
 1074: {QUEST: 'Canary Coalmine needs help retrieving some coal.\x07You better help her if you have the fuel._where_'},
 1075: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "Don't have my coal yet?",
        QUEST: "Buena suerte, _avName_.\x07I've walked all the way here, and this building looked quite nice to lease.\x07I heard that this playground has tons of coal!\x07The Sellbots love that good stuff.\x07Can you obtain some of that sweet coal from the Sellbots please?",
        COMPLETE: 'Toontastico!\x07This will last me awhile.\x07Say, a long time ago I picked up this really big jar of jellybeans.\x07I have no need for it anymore.\x07You can have it.'},
 1076: {QUEST: 'Will Wiseacre has ran out of noisemakers.\x07He needs help getting his supplies._where_'},
 1077: {QUEST: "Heya, _avName_!\x07As you know, I make the best noisemakers here in Toontown Central.\x07However, one of my business partners, _toNpcName_, has not been sending me supplies!\x07Can you please visit him?",
        LEAVING: ''},
 1078: {QUEST: "Welcome to the Chortle Cafe!\x07How may I help you?\x07Ah, so Will sent you?\x07I would be sending him the proper supplies, however the Cogs took most of my inventory! If you retrieve them, I'll properly send them to Will.",
        INCOMPLETE_PROGRESS: "Where is my supplies? I can't make the noisemakers yet.",
        LEAVING: '',
        GREETING: ''},
 1079: {QUEST: 'Thanks, you got them back!\x07Please go deliver them to Will._where_',
        LEAVING: '',
        GREETING: ''},
 1080: {QUEST: "Welcome back!\x07Did you get the supplies?\x07That is great to hear.\x07So the Cogs took Charlie's supplies?\x07That must explain most of it.\x07Thanks to you, I'm now back making more noisemakers!\x07Since you're already here, could you deliver some to the Toon HQ?\x07They can give you your reward there.",
        GREETING: '',
        COMPLETE: 'You got the noisemakers!\x07Send our thanks back to Will.\x07For your reward, this will be a special one.\x07Teleport access allows you to travel to a playgtround with your portable hole using the map in the Shtiker Book.'},
 1081: {QUEST: 'Loony Louis needs some help with his clown cars._where_'},
 1082: {GREETING: 'Woohoo!',
        QUEST: "Yowza!\x07I can't find the tires to this here clown car anywhere!\x07Do ya think you could help me out?\x07I think _toNpcName_ may have tossed them in the pond in the Toontown Central playground.\x07If you stand on one of the docks there, you can try and fish out the tires for me.",
        INCOMPLETE_PROGRESS: 'Are you having trouble fishing out all four tires? As I said, they can be found in Toontown Central.',
        LEAVING: ''},
 1083: {QUEST: 'Fan-flying-tastic!\x07Now I can get this old clown car on the road again!\x07Hey, I thought I had an air pump around here to inflate these tires...\x07Maybe Lucy Tires borrowed it? Could you go ask for it back for me?_where_',
        GREETING: '',
        LEAVING: ''},
 1084: {QUEST: "Hi there.\x07A tire pump you say?\x07I'll tell you what - you help me clean up the streets of some of those high level Cogs for me...\x07And I'll let you have the tire pump.",
        INCOMPLETE_PROGRESS: 'Is that the best you can do?',
        GREETING: '',
        LEAVING: ''},
 1085: {QUEST: "Good job - I knew you could do it.\x07Here's the pump.\x07I'm sure _toNpcName_ will be glad to get it back.",
        GREETING: '',
        LEAVING: '',
        COMPLETE: "Yeehaw!\x07Now I'm good to go!\x07By the way, thanks for helping me out.\x07Here, take this.\x07It will allow you easy access for the best kart racing in town!\x07If you are interested, just open up the map in the Shtiker Book, and press the \"Goofy Speedway\" button!"},
 1086: {QUEST: "This is urgent!\x07Word has gone around that a new one of these Cog Buildings has been constructed off Tutorial Terrace.\x07We don't have much word on this situation, but perhaps some witnesses can be interviewed.\x07Please visit Inflatable Wrecking Balls, and then report back._where_"},
 1087: {GREETING: '',
        LEAVING: '',
        QUEST: "Hello?\x07What do you want?\x07New Cog Building in Tutorial Terrace?\x07Well lately, Tutorial Tom has not been walking around.\x07He usually chats with everyone here from time to time.\x07Now that I think about it, he hasn't shown up in awhile.\x07I hope he is doing fine."},
 1088: {QUEST: "What is the word?\x07Tutorial Tom is missing?\x07Oh no, this can't be good.\x07We are going to have to investigate this further.\x07Perhaps Sid Seltzer might know a thing or two._where_",
        LEAVING: ''},
 1089: {QUEST: "Whatcha need?\x07Uh huh.\x07Uh huh...\x07Look, he has been missing for a while now.\x07I think that new building has been constructed for quite some time too.\x07Unlike other Cog Buildings that have gone up and down, this one hasn't fallen at all.\x07Other than that, there is nothing else that I can recall."},
 1090: {QUEST: "What did Sid say?\x07That building doesn't like to go down, huh?\x07Weird, I haven't seen that before.\x07The only thing I am missing are the Cogs in that building.\x07Dr. Tom is an expert on everything.\x07He will answer my question._where_'",
        LEAVING: ''},
 1091: {QUEST: "Ah, a new face.\x07What brings you here?\x07An HQ Officer, eh?\x07What is needed?\x07A Cog Building that doesn't go down?\x07Listen, I've been in that building.\x07I wouldn't go in there if I were you.\x07Trust me, you'll get a bunch of bruises from that Flunky.",
        LEAVING: ''},
 1092: {QUEST: 'What did the doctor prescribe?\x07A Flunky in that building?\x07Oh, that is no big deal.\x07Flunkies are easy to deal with.\x07Just take down that building, and the problem will be solved.\x07The Cog Building is located off Tutorial Terrace.\x07Tutorial Terrace can be found near Toontown School House.\x07Good luck, Toon!',
        GREETING: '',
        LEAVING: '',
        COMPLETE: "How did it go?\x07That monster didn't crumble, huh?\x07That is a tough building it seems.\x07Say, you have put in tons of hard work in helping us keep Toontown as silly as possible.\x07The Toon Council would like to present you with a new Gag Track.\x07For now, your work is done in Toontown Central.\x07I heard that Donald's Dock needs a lot of help.\x07If you walk through the end of Punchline Place, you'll be in Donald's Dock.\x07Good luck with your future journey!"},
 ...
 2216: {QUEST: "Gosh! You just missed him, sweetie.\x07There was a Ratifier in here. He took my big white wig.\x07He said it was for his boss and something about 'legal precedent.'\x07If you can get it back I'd be forever grateful.",
        LEAVING: '',
        GREETING: '',
        INCOMPLETE_PROGRESS: "Still haven't found him?\x07He's medium-sized and has foggy glasses.",
        COMPLETE: "You found it!?!?\x07Aren't you a darling!\x07You've more than earned this..."},
 2217: {QUEST: "So Melville wants ballast, does he?\x07He still owes me for the last bushel.\x07I'll give it to you if you can clear five Pushovers off the buildings.",
        INCOMPLETE_PROGRESS: 'No, silly! I said FIVE Pushovers...',
        GREETING: 'What can I do for you?',
        LEAVING: ''},
 2218: {QUEST: "Hi, _avName_. Thank goodness you're here. A mean looking Pawnbroker was just in here and he made off with an inner tube.\x07I fear they may use it for their vile purposes.\x07Please see if you can find him and bring it back.",
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Any luck finding my inner tube?',
        COMPLETE: 'You found my inner tube! You ARE good. Here, take your reward...'},
 2219: {QUEST: '_toNpcName_ had one of his items stolen, and needs help finding it._where_'},
 2220: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Have you found my hat yet?',
        QUEST: "Ahoy, _avName_!\x07A mean Stooge ran off with one of me hats!\x07He said it was for a Downsizer.'\x07I hope you can fetch it back for me.",
        COMPLETE: 'Say there, that hat is in great condition.\x07Here, take a treat.'},
 ...
 3307: {QUEST: "Hello, _avName_! Have you come to help me?\x07I just chased two Backseat Drivers out of my shop. Whew! That was scary.\x07But now I can't find my scissors anywhere!\x07I'm sure those Backseat Drivers took two pairs!\x07Find those Backseat Drivers, and recover my scissors for me.",
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Are you still looking for my scissors?',
        COMPLETE: 'My scissors! Thank you so much! Here is your reward...'},
 ...
 3300: {QUEST: 'Hi, _avName_! Thanks for coming by!\x07A bunch of Double Crossers just broke in and stole a stack of postcards from my counter.\x07Please go out and defeat all those Double Crossers to get my postcards back!',
        INCOMPLETE_PROGRESS: "That's not enough postcards! Keep looking!",
        COMPLETE: 'Oh, thank you! Now I can deliver the mail on time! Here is your reward...'},
 ...
 3301: {QUEST: "We've been performing some studies on Sellbot mechanics.\x07We still need to study some pieces more closely.\x07Bring us a sprocket from a Forecaster.\x07You can find these Cogs in Sellbot buildings.\x07You can catch one when the Cog is exploding."},
 3302: {QUEST: 'Good job! Now we need a sprocket from a Bamboozler for comparison.\x07You can find these Cogs in Sellbot buildings.\x07These sprockets are harder to catch, so keep trying.'},
 3303: {QUEST: 'Great! Now we need just one more sprocket.\x07This time, we need a sprocket from a Handsome Devil.\x07You might need to look harder into Sellbot buildings to find these Cogs.\x07When you catch one, bring it back for your reward.'},
 ...
 3304: {QUEST: "We've been performing some studies on Lawbot mechanics.\x07We still need to study some pieces more closely.\x07Bring us a sprocket from a Double Crosser.\x07You can find these Cogs in Lawbot buildings.\x07You can catch one when the Cog is exploding."},
 3305: {QUEST: 'Good job! Now we need a sprocket from a Ratifier for comparison.\x07You can find these Cogs in Lawbot buildings.\x07These sprockets are harder to catch, so keep trying.'},
 3306: {QUEST: 'Great! Now we need just one more sprocket.\x07This time, we need a sprocket from The Magister.\x07\x07You might need to go into big Lawbot buildings to find these Cogs.\x07When you catch one, bring it back for your reward.'},
 ...
 3307: {QUEST: 'Uh oh! A Mr. Hollywood stole the script of this ToonTask!\x07We need the script of this ToonTask.\x07Remember, Mr. Hollywoods can be found inside Sellbot buildings.'},
 3308: {QUEST: "You found the script!\x07Now let's read what we have here.\x07Handsome Devils have stolen our portal to Sellbot HQ!\x07We need the portal in order to easily access Sellbot HQ.\x07Remember, Handsome Devils can be found inside Sellbot buildings."},
 4001: {GREETING: '',
        QUEST: 'Now you get to choose the next gag track you want to learn.\x07Take your time deciding, and come back here when you are ready to choose.',
        INCOMPLETE_PROGRESS: 'Think about your decision before choosing.',
        INCOMPLETE_WRONG_NPC: 'Think about your decision before choosing.',
 ...
 4225: {QUEST: "_toNpcName_ has received reports of a new rumor!\x07Why don't you zither there, and check out the news?_where_"},
 4226: {GREETING: '',
        LEAVING: '',
        QUEST: 'Welcome, _avName_!\x07This report will make your heart beat.\x07Rumor has it a Cashbot Headquarters has popped up at Tenor Terrace.\x07Can you investigate, and confirm the suspicions?\x07Defeat some Cashbots in there, and play it back to me.',
        INCOMPLETE_PROGRESS: 'There has to be a Cashbot Headquarters out there...'},
 4227: {GREETING: '',
        LEAVING: '',
        QUEST: 'Play it back to me.\x07Uh huh...\x07Hm....\x07A massive headquarters?\x07We need to gather more data about this.\x07Oh, I know!\x07There is bound to be Number Crunchers in there.\x07Go defeat Number Crunchers at the HQ until you find some data then come back!',
        INCOMPLETE_PROGRESS: "You don't seem to have enough data yet.",
        COMPLETE: "Do you have the data?\x07Let's download what we have here.\x07Oh my...\x07The Cashbots built a Mint to produce Cogbucks.\x07There has to be a BIG showing of Cashbots in there.\x07A lot more needs to be discovered.\x07You know what, I got it!\x07What if you had a disguise?\x07I have part of a Cog suit you can use.\x07Here, it might be useful for something..."},
 4228: {QUEST: "_toNpcName_ has been very excited about the reports of Cashbot Headquarters.\x07However, he doesn't want to go in there alone._where_"},
 4229: {GREETING: '',
        LEAVING: '',
        QUEST: "Yo, yo, yo.\x07The new Cashbot HQ is poppin'.\x07Y'know, there's lots of valuables in there.\x07Ask my boy _toNpcName_ if he'd like to join Cashbot HQ with me._where_"},
 4230: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "Can't find Gold Bricks?\x07The precious gold can be found in Cog Buildings.",
        QUEST: "What brings you here?\x07Cashbot HQ with Banker Bran?\x07Sorry, but I don't think Cashbot HQ is that valuable.\x07There isn't enough Gold Bricks in there!\x07Say, I could go for some precious gold right now.\x07Fight some of those shiny Gold Bricks then give me the goodies."},
 4231: {GREETING: '',
        LEAVING: '',
        QUEST: "Now that's what I'm talking about!\x07Canary Coalmine would be jealous of these findings.\x07I can't keep you here forever, so I wish _toNpcName_ the best of luck."},
 4232: {GREETING: '',
        LEAVING: '',
        QUEST: "Ay, what was taking so long?\x07My boy said no?\x07I ain't going in the HQ alone.\x07Pass me some of those Money Bags from Cashbot HQ, and I'll have something cookin' for ya.",
        INCOMPLETE_PROGRESS: "Huh?  Where's my cash?",
        COMPLETE: "Sweet, sweet, money!\x07You won't believe what I got cookin'.\x07A Cog dropped some of its parts, and I obtained one.\x07You want it?\x07Here you go."},
 4233: {QUEST: 'Cogs have been hampering business at Club 88.\x07Go see _toNpcName_ and see what can be done._where_'},
 4234: {GREETING: '',
        LEAVING: '',
        QUEST: "What's crackin', _avName_.\x07Those freaky deaky Cogs are at it again!\x07They've been bothering all my patrons!\x07You better boogie down to the streets, and put the metal to the pedal.",
        INCOMPLETE_PROGRESS: "I think you need to boogie a little more.",
        COMPLETE: "Say, I like your style, Toon.\x07You could use something special.\x07Here, I got a groovy Cog suit part.\x07Remember, stay classy."},
 4235: {QUEST: "The Cogs have been giving _toNpcName_ a slow service!\x07Check out what's cooking, and see if you can speed up the pace._where_"},
 4236: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "Have you found my flour yet?",
        QUEST: "Oh my!\x07Service has been a mess!\x07Those Cogs have been running off with my ingredients.\x07Wait a second...\x07I hear a Cog walking with my flour out there!\x07Please go find that Cog."},
 4237: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Darn! That butter must be hard to find!',
        QUEST: "Yippie!\x07We're one step closer to making pancakes.\x07However, I saw one of those Cashbots running into the HQ with my butter!\x07I can't make pancakes without the butter."},
 4238: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "I hope those Fat Cats haven't drank my milk...",
        QUEST: "Wowza!\x07You seem to be getting the ingredients quick.\x07I have one more ingredient missing.\x07One of those Fat Cats ran off somewhere with my milk!\x07Make sure that Cog hasn't drank it yet."},
 4239: {GREETING: '',
        LEAVING: '',
        QUEST: "Yes!\x07It appears the milk hasn't been touched.\x07Now, let me quickly whip up these pancakes.\x07They don't take that long to make.\x07A little cracking, some mixing, and a little pizzazz -- these are good to go.\x07Say, I have a customer that needs some pancakes if you don't mind.\x07No need to come back because she is a great tipper._where_",
        COMPLETE: 'About time!\x07Oh, these pancakes make me want to dance.\x07Thanks for the delivery.\x07You could use a big tip.\x07I have something a little rare around somewhere...\x07Oh, there it is!\x07Behold, a Cog suit part!\x07I have no need for it anymore.\x07I found it a while back, and I am sure it will be useful for something...'},
 4240: {QUEST: '_toNpcName_ is losing out her business to the Cogs.\x07She needs someone to pop in and help._where_'},
 4241: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'There is still too much Cog Buildings around here!',
        QUEST: "Say, business has been very bad lately.\x07Those Cogs keep building and building, and no one has stopped it!\x07Deliveries haven't been as strong lately.\x07Can you clear some of those Cog Buildings for me?"},
 4242: {GREETING: '',
        LEAVING: '',
        QUEST: 'Ah, the streets are looking cleaner than ever.\x07How about you help me make a few deliveries?\x07Here is a couple bottles of Coda Pop.\x07Oh, and I almost forgot!\x07Here is the list of deliveries.\x07Follow the ToonTasks, and you will find the places in no time!'},
 4243: {QUEST: "Delivery for me?\x07You won't believe how tasty these pops are.\x07I've always wanted to install a vending machine full of these things, but haven't had the time.\x07Tell Cammy I give her my thanks!"},
 4244: {QUEST: 'The Coda Pops are finally here?\x07What a relief!\x07I have a bunch of recordings planned using these.\x07I make the best of the best sound effects in town.\x07Give Cammy a wave for me!'},
 4245: {QUEST: "I hate to go off script here, but I simply can't resist the urge to have a Coda Pop.\x07I drink these for Breakfast, Lunch, and Dinner.\x07Ok, fine.\x07I also like drinking these in between commercial breaks too.\x07But don't tell that to my buddies.\x07I love Coda Pops, and I sure want to kiss Cammy right now.",
        COMPLETE: "How did the deliveries go?\x07You may have learned this, but everyone around here loves my Coda Pops.\x07I would love to hand you one right now, but I need some time to produce more.\x07However, I have this Cog part lying around if that will make it up."},
 4246: {QUEST: '_toNpcName_ has broke one of her tires!\x07It could use a repair._where_'},
 4247: {QUEST: "The Blues News spreading around is true!\x07My tire has gone broke, and I don't have the strength to move it around.\x07Can you take it to _toNpcName_?_where_",
        GREETING: ''},
 4248: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'You got any luck yet?',
        QUEST: "Oh, I know what you're in here for already.\x07That news has spread around like wildfire.\x07Let me check out the condition of this tire.\x07Hm...\x07Yeah, bud.  This ain't going to work out.\x07It's too busted up.\x07I have an idea.\x07Maybe we can take advantage of a big problem around town.\x07Toons tend to lose their tires mainly on the ponds.\x07I don't know what it is about ponds and tires, but they spell disaster.\x07Go a little fishing, and you might happen to find a tire."},
 4249: {GREETING: '',
        LEAVING: '',
        QUEST: "Oh, good.  You found one.\x07Oh, it's a little beat up, but I can fix it.\x07Why don't you go take care of a few Cogs while I repair it?"},
 4250: {GREETING: '',
        LEAVING: '',
        QUEST: "Oh, it's good as new.\x07I don't understand why the Hogg couldn't take her own tire here, but whatever.\x07Deliver the tire back; it's free of charge.\x07Later, gator!",
        COMPLETE: "Wow, the tire looks good!\x07What did he do to it?\x07Huh, you don't know?\x07Oh well.\x07I really appreciate the help.\x07Say, I have this sitting around.\x07I don't know what it is, but it might have some use.\x07Here it is."},
 4251: {QUEST: '_toNpcName_ needs a middleman to help her pawn her watch._where_'},
 4252: {QUEST: "Listen, I need a quick favor.\x07Fran Fret holds a bit of a grudge towards me.\x07I'm a little low on money.\x07Can you take this watch, and pawn it for me?_where_",
        LEAVING: ''},
 4253: {QUEST: "Welcome to my Pawn Shop!\x07What do we have here?\x07Hmm, let's see...\x07Yeah, I can't take it.\x07It's worth nothing.\x07Grab your watch, and take it back where it came from.",
        LEAVING: ''},
 4254: {QUEST: "Did she take the watch?\x07No?\x07Dang it!\x07Let's try this watch.\x07It's a little different.\x07Try pawning it.",
        LEAVING: ''},
 4255: {QUEST: "Back so soon?\x07Another watch you say?\x07Let's take a quick look, shall we?\x07You know, I still can't take it.\x07This is also worth nothing.\x07It looks like a watch straight out of Common Time Watches.\x07Huh?\x07So they are from there!\x07Say, those Pawnbroker Cogs are stealing my business!\x07Knock a few of them out, and I'll work out something with Karen.",
        LEAVING: ''},
 4256: {QUEST: 'Listen, I worked out something with Karen.\x07Please visit her when you have the chance.',
        LEAVING: ''},
 4257: {QUEST: "You may have heard this, but we worked something out.\x07The only issue is I don't have the stainless steel she asked for.\x07They're usually found in fishing ponds, if you can fish some up for me.",
        LEAVING: ''},
 4258: {QUEST: 'Fantastic!\x07This will do the trick.\x07Now, while I whip something up, can you take down a few of those Cashbot buildngs?',
        LEAVING: ''},
 4259: {QUEST: 'The Stainless Steel Watch is all ready to go!\x07This will sure get us on good terms.\x07With some care, please take it to her.',
        LEAVING: ''},
 4260: {QUEST: "Wow, you must hate coming back here.\x07Again, let me take a look at what she brong...\x07This time, it is worth something!\x07Finally a good watch!\x07I can hand her a good amount of Jellybeans.\x07Stuff her mouth with this jar, and that'll zip her up.",
        COMPLETE: "Woah, look at that beauty!\x07I cannot thank you more than enough for the favor.\x07You could use something a little uncommon...",
        LEAVING: ''},
 4261: {QUEST: "_toNpcName_ needs help sending a gift.\x07I heard it's for someone special._where_"},
 4262: {GREETING: '',
        LEAVING: '',
        QUEST: "Kali mera, _avName_.\x07A special occassion is coming up between the love of my life and I, and I need some assistance.\x07I've been a bit busy lately, and haven't been able to find a gift box.\x07Can you buy me a gift box from the nearby shop?_where_"},
 4263: {LEAVING: '',
        INCOMPLETE_PROGRESS: "I'm starting to think the gift box might be missing...",
        QUEST: "Whatcha looking for?\x07Gift box, eh?\x07A hoodlum Robber Baron just took the last one.\x07If you are swift enough, you might be able to find it."},
 4264: {GREETING: '',
        LEAVING: '',
        QUEST: "That's it all right.\x07Let me check the condition real quick.\x07No scratches, no nothing.\x07It's all good to go.\x07Here, take the gift box.\x07No need to pay me."},
 4265: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "It would be a really big Greek tragedy if that letter was gone.",
        QUEST: "Yiasou, _avName_.\x07Seems like you got the perfect gift box!\x07This will go great with my love letter.\x07Hold on, where is it?\x07Ah, I think it flew away.\x07A Cog probably took it by now.\x07Quick, get my love letter back!"},        
 4266: {GREETING: '',
        LEAVING: '',
        QUEST: "Yiasou, _avName_.\x07Can you hand over the love letter really quick?\x07Wow!\x07Thankfully, there's no rips, wrinkles, or anything done to it.\x07Speaking of love letters, can you deliver it to my meli mou?"},
 4267: {LEAVING: '',
        QUEST: "Oh, love letter for me?\x07Let's read what we have here.\x07Oh...\x07George is such a great guy.\x07A lot of thought and effort was put into this.\x07Tell him I give him all of my kisses.",
        COMPLETE: 'Yiasou, _avName_.\x07What did she think?\x07Did she love it?\x07Oh, she did?\x07That is great to hear.\x07Stay here for a second, let me feed you up.\x07Just another second...\x07Here you go, kali orexi!'},
 4268: {QUEST: 'Those mean Cashbots are at it again!\x07_toNpcName_ needs help keeping some off his back._where_'},
 4269: {GREETING: '',
        LEAVING: '',
        QUEST: "Ciao, _avName_!\x07De recent Loano Sharkza at-tacks ave been a paina deala with!\x07\"Paya oo-pa\", dey said!.\x07No no, we no wanta do dat!\x07Defeat a couple Loano Sharkza, yeza?",
        COMPLETE: "Ciao, _avName_!\x07Dose Loano Sharkza no show oop anymorrre..\x07You did ita!\x07Grazie, grazie!\x07Say, I gotza extra Coga parta lying arounda!\x07Take it, take it!"},
 4270: {QUEST: "_toNpcName_ is in a bit of a panic.\x07He needs some help before a special customer comes back._where_"},
 4271: {LEAVING: '',
        QUEST: "I can't believe it!\x07Out of all these years, this hasn't happened EVER.\x07Those Cashbots have stolen a customer's tuxedo!\x07He is supposed to be coming in a few minutes.\x07Hurry up, and find that tuxedo!",
        INCOMPLETE_PROGRESS: "Hurry up!\x07We don't have all of the time in the world.",
        COMPLETE: "The customer called, and he's almost here!\x07Is it damaged?\x07Oh, let me take a quick look.\x07Hold on, there is something attached to it.\x07Looks like a Cog suit part.\x07If I quickly remove that...\x07The tuxedo is good as new!\x07I think this was from your Cog, so you get to keep it!"},
 4272: {QUEST: '_toNpcName_ has been out of tune.\x07I hear the Cogs might be causing it._where_'}, # 
 4273: {LEAVING: '',
        QUEST: 'Those Cashbots have been taking my CDs!\x07Those are worth a lot, you know!\x07If I can get them back, that would put me back in tune.',
        COMPLETE: 'Oh, come back to June Loon!\x07Thank you for finding my precious CDs!\x07Speaking of precious, take this...'},
 4274: {QUEST: '_toNpcName_ is complaining about her lack of business.\x07Please take a ride over, and check out the problem._where_'},
 4275: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "Keep fighting those Cashbots.\x07I'm still working on something.",
        QUEST: "You feeling me, _avName_?\x07Those Cashbots have been hatin'!\x07Ever since that HQ opened up, I haven't had any riders.\x07What is even behind that HQ anyways?\x07I've heard rumors about TONS of Cashbots being in there, so that must be what's bothering my business.\x07Please take care of those Cashbots in there, and I promise I'll have something for you.",
        COMPLETE: "Cool, that should do the job.\x07That'll get people ridin' again.\x07Speaking of ridin'...\x07Here, let me teach you a thing or two about ridin' into this HQ."},
 4276: {QUEST: '_toNpcName_ has been disturbed by a dirty Cashbot Headquarters.\x07She needs you to help \"clean\" it up._where_'},
 4277: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "You don't look dirty enough.\x07Keep cleaning!",
        QUEST: "Oh my, oh my.\x07That HQ nearby has been a total mess!\x07I've tried cleaning those Mints multiple times, but those Cashbots just won't let me!\x07Say, you look a little strong.\x07Can you please clean a couple of Cashbot Mints in that headquarters?",
        COMPLETE: "Wow, you look dirty.\x07While I wasn't able to clean the Mints, I did find this laying on the ground.\x07It looks like a Cog suit part.\x07Here, take it.\x07Oh.\x07It appears you have a full Cashbot disguise now.\x07That will come in handy to clean the area beyond those giant doors..."},
 ...
 5263: {GREETING: '',
        ...
        COMPLETE: 'Yeehaw! You found it!\x07 Here, take your reward...'},
 5501: {GREETING: '',
        QUEST: 'Hi, _avName_.  I reckon I should thank you for coming.\x07A group of those White Knights came in and stole my soccer ball.\x07The leader told me that I had to make some cutbacks and just grabbed it away from me!\x07Can you get my ball back?',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Any luck finding my soccer ball?',
        COMPLETE: 'Yeehaw! You found it!\x07 Here, take your reward...'},
 5502: {GREETING: '',
        QUEST: 'Hi, _avName_.  I reckon I should thank you for coming.\x07A group of those Handsome Devils came in and stole my soccer ball.\x07The leader told me that I had to make some cutbacks and just grabbed it away from me!\x07Can you get my ball back?',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Any luck finding my soccer ball?',
        COMPLETE: 'Yeehaw! You found it!\x07 Here, take your reward...'},
 5503: {GREETING: '',
        QUEST: 'Hi, _avName_.  I reckon I should thank you for coming.\x07A group of those Fat Cats came in and stole my soccer ball.\x07The leader told me that I had to make some cutbacks and just grabbed it away from me!\x07Can you get my ball back?',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Any luck finding my soccer ball?',
        COMPLETE: 'Yeehaw! You found it!\x07 Here, take your reward...'},
 5504: {GREETING: '',
        QUEST: 'Hi, _avName_.  I reckon I should thank you for coming.\x07A group of those Magisters came in and stole my soccer ball.\x07The leader told me that I had to make some cutbacks and just grabbed it away from me!\x07Can you get my ball back?',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Any luck finding my soccer ball?',
        COMPLETE: 'Yeehaw! You found it!\x07 Here, take your reward...'},
 ...
 5275: {GREETING: '',
        ...
        INCOMPLETE_PROGRESS: 'No luck finding my keboard?'},
 5505: {GREETING: '',
        QUEST: "Yeah, that's my microphone all right.\x07Thanks for getting it for me, but...\x07I really need my keyboard so I can tickle the ivories.\x07I think one of those White Knights got my keyboard.",
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'No luck finding my keboard?'},
 5506: {GREETING: '',
        QUEST: "Yeah, that's my microphone all right.\x07Thanks for getting it for me, but...\x07I really need my keyboard so I can tickle the ivories.\x07I think one of those Handsome Devils got my keyboard.",
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'No luck finding my keboard?'},
 5507: {GREETING: '',
        QUEST: "Yeah, that's my microphone all right.\x07Thanks for getting it for me, but...\x07I really need my keyboard so I can tickle the ivories.\x07I think one of those Fat Cats got my keyboard.",
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'No luck finding my keboard?'},
 5508: {GREETING: '',
        QUEST: "Yeah, that's my microphone all right.\x07Thanks for getting it for me, but...\x07I really need my keyboard so I can tickle the ivories.\x07I think one of those Magisters got my keyboard.",
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'No luck finding my keboard?'},
 5254: {GREETING: '',
 ...
 5400: {QUEST: "_toNpcName_ just saw a new Lawbot Headquarters!\x07If you stop by, maybe you'll see it too._where_"},
 5401: {QUEST: "I saw it...\x07It was big and rectangular.\x07They even have their own offices in there!\x07And there's also Cogs walking in there!\x07You should see it too!\x07Defeat some Lawbots in the HQ and then come back.",
        INCOMPLETE_PROGRESS: 'Have you seen the Lawbot HQ yet?',
        LEAVING: ''},
 5402: {QUEST: "See what I'm talking about?\x07It's huuuuuuge!\x07We need to find out more about that HQ!\x07I saw those Cogs carrying around some of these weird papers.\x07Can you go grab some from the HQ?",
        INCOMPLETE_PROGRESS: "You haven't found the papers yet?",
        LEAVING: ''},
 5403: {QUEST: "Ooooh, I see papers right there.\x07Let me take a quick look...\x07Oh.\x07I can't understand any of this.\x07This might be useful for Toon HQ if you can deliver them over there.",
        LEAVING: '',
        COMPLETE: "What are you holding there?\x07Papers from Lawbot HQ?\x07Oh, this is some useful information.\x07We've heard rumors about a Lawbot HQ, but haven't looked into it.\x07Say there, _avName_.\x07We have something that might be a little useful lying around somewhere...\x07Ah hah!\x07Here it is.\x07It is a Cog suit part.\x07It might be useful for the rumored Lawbot HQ..."},
 5404: {QUEST: '_toNpcName_ needs some help clearing the streets.\x07Please give him a hand.'},
 5405: {QUEST: 'Oh my galoshes!\x07Those Lawbots are piling on the streets!\x07They must be plotting something.\x07Please help me shovel them off the streets!',
        INCOMPLETE_PROGRESS: 'Oh my galoshes!\x07Those Lawbots are still piling up!',
        LEAVING: '',
        COMPLETE: "That's more like it!\x07The streets are clear, but only for now...\x07Let me give you a little surprise.\x07There you go!"},
 5406: {QUEST: '_toNpcName_ is having a rough time doing business.\x07Can you show him how to run his shop?_where_'},
 5407: {QUEST: "Oh, hello there.\x07Lately those Cogs have been slowing my business!\x07There's too much Cog buildings to clear them alone.\x07Wipe out a few Cog buildings to keep my business running and I'll exchange something in return.",
        GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'I have no jobs coming in. Please wipe out those buildings!',
        COMPLETE: "Now I'll have jobs for days!\x07I'm going to make a lot of cash!\x07Now, let me give you something in return.\x07There you go!"},
 5408: {QUEST: '_toNpcName_ is having trouble operating her bakery.\x07Can you stop by and lend her some help?_where_'},
 5409: {QUEST: 'Oh, thank goodness for you!\x07Those Cogs have stopped me from being able to deliver my Baked Alaskas.\x07I walk outside, and SPLAT they go!\x07Could you please clean up the streets for me?',
        INCOMPLETE_PROGRESS: "There is too much Cogs on the street for me to deliver!",
        GREETING: '',
        LEAVING: '',
        COMPLETE: "Say, the streets are looking cleaner than ever!\x07Thanks for the making the area safe again!\x07Here, I've fried something up for you."},
 5410: {GREETING: 'I heard _toNpcName_ lost something important.\x07Please visit him so he will be joyful again.'},
 5411: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "Say there, _avName_. Those aren't enough bells.",
        QUEST: "Ho, ho, ho!\x07I was riding my sleigh, and I think I lost my bells in the nearby pond!\x07Fish them up for me, and I'll give you a present.",
        COMPLETE: "Oh, what a miracle!\x07My sleighs are going to sound better than ever.\x07Now, that present of yours...\x07It's all wrapped and ready for service!\x07Here it is!\x07Have a merry good day!"},
 5412: {QUEST: '_toNpcName_ is having trouble conducting weather research.\x07You should give him a visit.\x07I heard he has a Lawbot disguise part._where_'},
 5413: {QUEST: 'Yes, yes. I have a Lawbot disguise part.\x07But it is of no interest to me.\x07The focus of my research is fluctuations in the ambient temperature of Toontown.\x07I will gladly trade you a disguise part if you can help me recover a Cog temperature sensor.',
        GREETING: '',
        LEAVING: '',
        COMPLETE: 'Ah yes, excellent!\x07Here is your Lawbot disguise part.'},
 5414: {QUEST: "_toNpcName_ hasn't been walking as much anymore.\x07Can you check out what's wrong?_where_"},
 5415: {QUEST: "Welcome, _avName_!\x07You see, those Lawbots have been taking over the sidewalks lately.\x07Every move I make, there's always a Lawbot coming out of that door!\x07If you can take out some of the nearby Lawbot Cog Buildings, I might be able to walk around again.",
        GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "Right now I don't feel safe enough to walk the sidewalks.",
        COMPLETE: "Wow!\x07The sidewalks haven't looked this empty in awhile.\x07Now I can walk around again!\x07Say, I've had something laying around for a long time now.\x07I have no intentions of carrying it around.\x07Here, take it, and walk with it in style."},
 5416: {QUEST: '_toNpcName_ wants to take over Lawbot HQ.\x07He needs YOU to help him out._where_'},
 5417: {QUEST: "THE NEWS IS TRUE!!\x07WE NEED TO DRAIN THE SWAMP OF LAWBOT HQ!!!\x07LET'S INVADE THOSE DA OFFICES!\x07WHAT ARE YOU WAITING FOR?\x07TAKE BACK LAWBOT HQ!",
        INCOMPLETE_PROGRESS: 'WHAT ARE YOU DOING? SAVE TOONTOWN FROM LAWBOT HQ!',
        GREETING: '',
        LEAVING: '',
        COMPLETE: "I am proud to say you did a great, great job for raiding those offices.\x07Here's a small loan of a key to Lawbot HQ.\x07Remember, your journey has only begun.\x07The CJ lying behind those HUUUGE left-side doors is next!\x07He doesn't know it yet, but we are going to win!"},
 ...
 6231: {QUEST: 'Nat over on Pajama Place heard rumors about a Bossbot Headquarters.\x07Head over there and see if you can help him out._where_'},
 6232: {GREETING: '',
        LEAVING: '',
        QUEST: "I got a nibble about some strange goings on.\x07Well, maybe it's the fleas but something is going on anyway.\x07All these Bossbots!\x07I think they've opened another headquarters right off Pajama Place.\x07P.J. knows his way around.\x07Go see _toNpcName_ _where_ Ask him if he's heard anything.",
        INCOMPLETE_PROGRESS: "You haven't seen P.J. yet? What's keeping you?\x07Oh, these darn fleas!"},
 6233: {GREETING: '',
        LEAVING: '',
        QUEST: "Hey there _avName_, where are you headed?\x07Bossbot Headquarters?? I've heard some rumors.\x07I think they built their own golf courses.\x07Could you go to the end of Pajama Place and see if it's true?\x07Crash a few golf courses, and come tell me about it.",
        INCOMPLETE_PROGRESS: "Found the HQ yet? You'll need to defeat a few of their golf courses to scope it out."},
 6234: {GREETING: '',
        LEAVING: '',
        QUEST: "What?! There really IS a Bossbot HQ?\x07You better go tell Nat right away!\x07Who would have guessed there'd be a Cog HQ right down the street from him?",
        INCOMPLETE_PROGRESS: "What did Nat have to say? You haven't seen him yet?"},
 6235: {GREETING: '',
        LEAVING: '',
        QUEST: "So, I'm itching to hear what P.J. had to say.\x07\x07Golf Courses, huh?\x07Hmm...we need more information about this Cog business but I've got to get rid of these fleas!\x07I know! YOU can go find out more!\x07Go defeat Bossbots at their golf courses until you find some plans then come right back!",
        INCOMPLETE_PROGRESS: "No plans yet? Keep searching those Cogs!\x07They're bound to have some plans!",
        COMPLETE: "You got the plans?\x07Great! Let's see what they say.\x07I see... the Bossbots built a Banquet to serve themselves.\x07It must be FULL of Bossbots. We should find out more about this.\x07Maybe if you had a disguise. Hmmm...wait! I think I've got part of a Cog suit here somewhere....\x07Here it is! Why don't you take this for your trouble? Thanks again for your help!"},
 ...
 6292: {QUEST: 'Oh those darn Bossbot Cogs! They stole my reading lamps!\x07I need them back right away. Can you go look for them?\x07If you can get my reading lamps, I might be able to help you get into see the C.E.O.\x07Hurry!',
 ...
 6293: {QUEST: 'White Knights are bothering the Wake-Up Phone Company.\x07I hope you are more than chicken enough to see _toNpcName_._where_'},
 6294: {GREETING: '',
        LEAVING: '',
        QUEST: "Those White Knights have been trying to buy my company!\x07They've been keeping me up all knight!\x07Can you wish those Cogs a good knight?",
        INCOMPLETE_PROGRESS: "They are still out there trying to buy my company!\x07Please take care of those White Knights!",
        COMPLETE: 'Are the White Knights gone?\x07I can go back to peace now!\x07Thank you so much, _avName_.\x07Say, I have a leftover Cog Part hanging around.\x07Here, it might be helpful for something...'},
 ...
 7211: {GREETING: '',
        LEAVING: '',
        QUEST: "So, Honey wants a bedspread, huh?\x07What color? BLUE?!\x07Well, I'd have to make that for her special. Everything I've got is red.\x07Tell ya what...if you'll go deal with some of those noisy Blowhards, I'll make a special blue bedspread just for her.\x07Blue bedspreads...what'll it be next?",
        INCOMPLETE_PROGRESS: 'Still working on this blue bedspread, _avName_. Keep at those Blowhards!',
        COMPLETE: ''},
 7212: {GREETING: '',
        LEAVING: '',
 ...
 7243: {GREETING: '',
        LEAVING: '',
        QUEST: "Oooh! Very slimy kelp you've got there, _avName_.\x07Now, I just crush some pearls with the mortar and pestle.\x07Um, where's my pestle? What good is a mortar without a pestle?\x07I bet that darn Corporate Raider took it when he came in here!\x07You need to help me find it! He was headed for Bossbot HQ!",
        INCOMPLETE_PROGRESS: 'I simply cannot crush the pearls without a pestle.\x07Darn those Corporate Raiders!'},
 7244: {GREETING: '',
        LEAVING: '',
 ...
 8400: {QUEST: 'Oh no! A Big Cheese has stolen the whey to Bossbot HQ!\x07We need the whey in order to quickly access Bossbot HQ.\x07Remember, Big Cheeses can be found inside Bossbot Buildings and Cog Golf Courses.'},
 8401: {QUEST: 'You found the whey alright.\x07Did I say whey?\x07I meant way.\x07The way to Bossbot HQ.\x07Quick, find another one of those Big Cheeses, and find the way to Bossbot HQ!\x07Remember, Big Cheeses can be found inside Bossbot Buildings and Cog Golf Courses.'},
}
...
RewardPanelCongratsStrings = ['Yeah!',
 ...
 'Awesome!',
 'Toon-tastic!']
RewardPanelMVP = 'Most Valuable Toon!'
...
AttackDescriptions = {
 'MysteriousDisappearance': 'The magic deals half of your max laff!',
 'TakeArticle': 'The loan rises!'
}
AttackExtendDesc = ['MysteriousDisappearance']
SuitAttackRounds = '%s Rounds Remaining.'
SuitAttackRoundsS = '1 Round Remaining.'
SuitAttackLastRound = 'Effect has expired.'
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
 ...
 'DoubleCross': ["Let this cross your face.",
                 ...
                 "You're about to be doublecrossed.",
                 'This attack is double the trouble!',
                 "You've been BETRAYED.",
                 'Time to change your plans.',
                 'Ever been duped?',
                 'Our promise is over.',
                 "Who holds his obligation? Not me!"],
 ...
 'Forecast': ["Today's forecast will have a chance of rain.",
              "Today's forecast will be cloudy with a chance of golfballs.",
 ...
 'PawerTie': ["I'll call later, you looked tied up.",
              ...
              'My pawers are far too great for you!',
              "I've got the pawer!",
              "By the pawers vested in me, I'll tie you up."],
 ...
 'PawerTrip': ["Pack your bags, we're taking a little trip.",
               'Did you have a nice trip?',
               "Nice trip, I guess I'll see you next fall.",
               'How was your trip?',
               'Sorry to trip you up there!',
               'You look a little tripped up.',
               "Now you see who's in pawer!",
               'I am much more pawerful than you.',
               "Who's got the pawer now?",
               "You can't fight the pawer.",
               'Pawer corrupts, especially in my paws!'],
 ...
 'Sandbagged': ["You've been sandbagged.",
                'I build great sandcastles.',
                "Looks like you're getting sandbagged.",
                "Don't worry, this attack isn't that good.",
                'Here is your baggage!',
                'This bag comes with an environmental fee.',
                'How about we play in the sand?',
                'The sand is a little damp.',
                "Let's go to the sandy beach!",
                'Ready to carry the baggage?'],
 ...
 'SongAndDance': ['How about we go for a little singing and dancing?',
                  "It's time to sing and dance!",
                  'Do you like to sing and dance?',
                  "I'm never too busy to sing and dance.",
                  'Ready for some singing and dancing?',
                  'How are my singing and dancing skills?',
                  'This is my show now!',
                  "You're not the only one who can dance!",
                  'This will be a showstopper!',
                  'Welcome to my show.'],
 ...
 'TakeArticle': ['Until further notice, this is now mine!',
                 'Mine, mine, mine!',
                 'Oh, this is very valuable.',
                 'What a gem.',
                 "If you can't pay back the loans, I keep it.",
                 "I'll quickly take this off your hands.",
                 'This item will come in handy.',
                 'This is a deal well made.',
                 'Say, your item is quite special.',
...
MinnieChatter = (['Welcome to Melodyland.', 'Hi, my name is ' + Minnie + ". What's yours?"], ['The hills are alive with the sound of music!',
  ...
  'Wow, there are lots of ' + Cogs + ' near ' + "Cashbot HQ",
...
AvatarChooserLoggingOut = 'Logging Out...'
...
MusicEncntrFinale = 'Cog Boss Victory'
...
ShtikerBookBackToPlayground = 'Back to Playground'
ShtikerBookBackToCogHQ = 'Back to Cog HQ'
ShtikerBookExitToontown = 'Exit Toontown'
MapPageTitle = 'Map'
MapPageGoHome = 'Head to Estate'
...
OptionsPageWhitelistOnLabel = 'Disable Whitelist'
OptionsPageWhitelistOffLabel = 'Enable Whitelist'
OptionsPageDaylightOnLabel = 'Disable Daylight'
OptionsPageDaylightOffLabel = 'Enable Daylight'
...
OptionsPageChatStyleLabel = 'Chat Color'
...
SuitPageThrowSummons = 'Would you like to show off your summons? You can press this button again to reverse this action.'
SuitPageRemoveSummons = 'Would you like to stop showing off your summons?'
...
FishPageTitleDailyCatch = 'Catch of the Day'
...
FishPageDailyCatch = 'Daily Catch'
FishPickerTotalValue = 'Bucket: %s / %s\nValue: %d jellybeans'
UnknownFish = '???'
UnknownDailyCatch = "Today's catch of the day is unknown."
KnownDailyCatch = "Today's catch of the day is %s."
WorthDoubleBeans = "If caught, bucket is worth 2x jellybeans!"
CatchOfTheDaySpotKnown = 'Catch of the day:\n %s'
FishCatchOfTheDay = 'Catch of the Day!'
FishingRod = '%s Rod'
...
TrackChoiceGuiChooseRandom = "I'm feeling lucky"
...
MessageConfirmTrackRandom = 'Clicking this button means that a random gag track is chosen. You are responsible for all damages done to your Toon if you do not get your desired gag track.\n\nAre you sure you want to pick a random gag track?'
...
EmoteSleep = 'Sleepy'
TIPPageTitle = 'TIP'
DailyRewardsPageTitle = 'Daily Rewards'
DailyRewardsClaimButton = 'Claim'
DailyRewardsClaimDescAvailable = 'Click the button below\nto claim a random reward.\nYou can claim a reward\nevery 24 hours!' 
DailyRewardsWaitingForServer = 'Waiting For Reward...'
DailyRewardSingular = "Congratulations! You've earned a %s!"
DailyRewardPlural = "Congratulations! You've earned %s %s!"
DailyRewardJellybeans = 'jellybeans'
DailyRewardSOS = '%s SOS Card'
DailyRewardPinkSlip = 'Pink Slip'
DailyRewardJellybeanUnite = '%s Jellybean Unite'
DailyRewardToonUpUnite = '%s Toon-Up Unite'
...
InventoryDetailCostS = 'Cost: %s Jellybean'
InventoryDetailCostP = 'Cost: %s Jellybeans'
...
InventoryToonUpString = 'Toon-Up'
InventoryDamageString = 'Damage'
InventoryLureString = 'Rounds Lured'
InventoryBattleMenu = 'BATTLE MENU'
InventoryRun = 'RUN'
InventorySOS = 'SOS'
InventoryPass = 'PASS'
InventoryFire = 'FIRE'
InventoryTaunt = 'TAUNT'
InventorySue = 'SUE'
...
BattleGlobalAvPropStringsPlural = (('Feathers',
 ...
 ('Flower Pots',
  ...
  'Grand Pianos',
  'Oceanliners'))
BattleGlobalAvTrackAccStrings = ('Med. (%s%%)',
 'Perf. (%s%%)',
 'Low (%s%%)',
 'High (%s%%)',
 'Med. (%s%%)',
 'High (%s%%)',
 'Low (%s%%)')
BattleGlobalLureAccLow = 'Low (%s%%)'
BattleGlobalLureAccMedium = 'Med. (%s%%)'
AttackMissed = 'MISSED'
AttackTaunted = 'TAUNTED'
AttackSued = 'SUED'
...
SueCogTitle = 'SUMMONS LEFT:%s\nSUE WHICH COG?'
SueCogLowTitle = 'SUMMONS LEFT:%s\nNOT ENOUGH SUMMONS!'
...
RaceGameCardTextHi2 = '%(name)s is one Fabulous Cog!'
...
WaitingForToonRewrite = 'Rewriting your Toon...'
...
NameShopToonCouncilRename = 'The Toon Council\nwill review your\nname.  ' + 'Review may\ntake a few days.'
...
STOREOWNER_BROWSING_GLOVES = 'You can browse, but you need a glove ticket to buy.'
STOREOWNER_BROWSING_NAMETAG_COLORS = 'You can browse, but you need 500 jellybeans to buy.'
STOREOWNER_NOFISH = 'Come back here to sell fish to the Pet Shop for jellybeans.'
STOREOWNER_NOFISH_DAILY_CATCH = 'Come back here to sell fish to the Pet Shop for jellybeans. The catch of the day is %s.'
...
STOREOWNER_TROPHY_BUCKET = 'Wow! You collected %s of %s fish. That deserves a trophy, bucket upgrade, and a Laff boost!'
LONELY_LOUIS_TOOKTOOLONG = 'SCRAM!'
LONELY_LOUIS_THANKSFISH = 'MMM... What a tasty meal for Lonely Louis! SCRAM!'
LONELY_LOUIS_NOFISH = 'GAH! You have no fish for Lonely Louis to consume?'
LONELY_LOUIS_TROPHY = 'WOWZA! You collected %s of %s fish. That deserves a trophy and a Laff boost!'
LONELY_LOUIS_TROPHY_BUCKET = 'WOWZA! You collected %s of %s fish. That deserves a trophy, bucket upgrade, and a Laff boost!'
CHEESY_CLEANER_NO_EFFECT = 'My vanishing cream will have no effect on you!'
CHEESY_CLEANER_GREETING = 'Would you like me to apply some vanishing cream?'
CHEESY_CLEANER_SUCCESS = 'Your cheesy effect has now vanished!'
CHEESY_CLEANER_AV_SAID_NO = 'When you need some vanishing cream, come back here!'
CheesyEffectCleanerConfirmation = 'Would you like to have some vanishing cream applied onto you?'
...
InvType2NameP = {
  ...
  6: 'Strikes From The Sea',
  7: 'Dual Dangers',
  8: 'The Yesmen Brothers',
  9: 'High Rankers'
}
...
CagedToonMVP = '\x07Oh, I see that you are the most valuable Toon!\x07Here, take a card of my friend %s.'
...
ResistanceToonCongratulations = "You did it!  Congratulations!\x07You're an asset to the Resistance!\x07Here's two of a special phrase you can use in a tight spot:\x07%s\x07When you say it, %s.\x07But it goes away when used, so choose that time well!"
...
ResistanceToonMVP = '\x07Oh, I see that you are the most valuable Toon!\x07Here, take another special phrase.\x07When you say it, %s.\x07But it goes away when used, so choose that time well!'
...
ResistanceToonWatchThis = 'Listen up!'
...
CashbotBossBattleThreeSpeech = [
 'Ughhh! You pesky Toons...',
 "You may be far into the vault -- but there is no getting out now.",
 "Security and I will handle it from here!"]
...
BossElevatorPromotionNotReady = 'Promotion Not Ready'
ElevatorPractice = 'Practice'
...
MessageConfirmRewrite = 'A Toon Rewrite allows you to change your body size, species, and color. You cannot reverse the effects of this item.\n\nAre you sure you want to change your look?'
MessageRewriteConfirmed = "In order to use a Toon Rewrite, you must exit to the Pick A Toon screen. A yellow button will be present under your name, which will allow you to change your body size, species, and color.\n\nMake sure you're happy with your new look, as you will need to buy another Toon Rewrite if you don't like it!"
MATRewriteConfirmation = 'Are you sure you want to rewrite your Toon?\n\nThis action is irreversible, and you will need to buy another Toon Rewrite if you want to change your look!'
MessageConfirmRename = 'A Toon Rename allows you to change your name. You cannot reverse the effects of this item.\n\nAre you sure you want to change your name?'
MessageRenameConfirmed = "In order to use a Toon Rename, you must exit to the Pick A Toon screen. A yellow button will be present under your name, which will allow you to change your name.\n\nMake sure you're happy with your new name, as you will need to buy another Toon Rename if you don't like it!"
MessageConfirmCatalogSkip = 'This item allows you to skip to the next Cattlelog issue. You cannot reverse the effects of this item.\n\nAre you sure you want to skip to the next Cattlelog issue?'
...
RewriteTypeName = 'Toon Rewrite'
RewriteTypeDesc = 'Change Your Look!'
RenameTypeName = 'Toon Rename'
RenameTypeDesc = 'Change Your Name!'
CatalogSkipTypeName = "Clarabelle's Cattlelog"
CatalogSkipTypeDesc = 'Next Cattlelog Issue'
HousePaintTypeName = 'House Paint'
...
BottomStylesDescriptions = {'bbs1': 'plain w/ pockets',
 ...
 'sil_bs1': 'Silly Cog-Crusher Shorts',
 'hw_bs3': 'Halloween Vampire Shorts',
 'hw_bs4': 'Halloween Turtle Shorts',
 'hw_gs1': 'Halloween Bee Shorts',
 'hw_gs2': 'Halloween Pirate Shorts',
 'hw_gs5': 'Halloween SuperToon Shorts',
 'hw_gs6': 'Halloween Vampire NoCape Shorts',
 'hw_gs7': 'Halloween Dinosaur Shorts',
...
CatalogPurchaseItemOnOrderPet = 'Nice choice! Did you know you can gift your Doodle a matching pair?'
...
CatalogNotForPets = 'Not For Pets'
...
CatalogWishStateNotEmpty = 'Name Already \nAwaiting Approval'
...
zone2TitleDict = {2513: ('Toon Hall', ''),
 ...
 4720: ('Wham! Long Lasting Christmas Trees', ''),
 ...
 4820: ('Catch A Dirty Ride Taxi Services', ''),
 4821: ("Anna's Cruises", ''),
...
FishTankValueDailyCatch = 'Hi, %(name)s! You have %(num)s fish in your bucket worth a total of %(value)s jellybeans with the daily catch bonus included. Do you want to sell them all?'
...
DidYouKnowDict = {TIP_NONE: ('',),
 TIP_GENERAL: ('Quickly check your ToonTask progress by holding down the "End" key.',
               ...
               'You can gift hat accessories to a Doodle in the cattlelog.'),
 ...
 TIP_COGHQ: ('You must complete your Sellbot Disguise before visiting the V.P.',
             ...
             "Earn Bossbot disguise suit parts as rewards for completing ToonTasks in Donald's Dreamland.",
             "Earn Cashbot disguise suit parts as rewards for completing ToonTasks in Minnie's Melodyland.",
             ...
             'Earn Lawbot disguise suit parts as rewards for completing ToonTasks in The Brrrgh.',
...
TIP_ALL = ('Flippy has been president of the Toon Council for a long time.',
 'Cleff LOVES Cream Pies.',
 'Jellybeans are perfectly edible.',
 "Toontown's pies are baked freshly every morning!",
 'The fun in Toontown never ends!',
 'The CJ thinks Toontown is an injustice?',
 'Lil Oldman is obsessed with Cog Buildings.',
 'Gear Grind is played in many countries.', 
 'There are over 50 Cogs in Gear Grind.',
 'A giant Gag Factory produces most gags in Toontown!',
 'A giant Cog Factory has produced almost every Cog in Toontown!')
...
WitnessToonCongratulations = "You did it!  Thank you for a spectacular defense!\x07Here, take these three papers the Chief Justice left behind.\x07With it you'll be able to summon Cogs from your Cog Gallery page, and bend the law in other ways."
...
WitnessToonMVP = '\x07Oh, I see that you are the most valuable Toon!\x07Here, take an extra summons.'
...
SummonDlgButton4 = 'Summon a Cog Invasion'
SummonDlgButton5 = 'Summon a Skelecog Invasion'
SummonDlgButton6 = 'Summon a Dance Unite'
SueCogButton = 'Sue'
SueCogConf = 'Would you like to sue a %s? This will cost %s summons paper.'
SueCogSueing = 'Suing Cog...'
SueLawsuitWon = 'Lawsuit Won!'
SueCogRewardJellybeans = "You have won the lawsuit! As a result, you've earned %s jellybeans!"
SueCogRewardClothingTicketS = "You have won the lawsuit! As a result, you've earned a Clothing Ticket!"
SueCogRewardClothingTicketP = "You have won the lawsuit! As a result, you've earned %s Clothing Tickets!"
SueCogRewardGloveTicketS = "You have won the lawsuit! As a result, you've earned a Glove Ticket!"
SueCogRewardGloveTicketP = "You have won the lawsuit! As a result, you've earned %s Glove Tickets!"
SueCogRewardPinkSlipS = "You have won the lawsuit! As a result, you've earned a Pink Slip!"
SueCogRewardPinkSlipP = "You have won the lawsuit! As a result, you've earned %s Pink Slips!"
SueCogRewardUniteS = "You have won the lawsuit! As a result, you've earned a %s Unite!"
SueCogRewardSosS = "You have won the lawsuit! As a result, you've earned a %s SOS Card!"
SummonDlgSingleConf = 'Would you like to issue a summons to a %s? This will cost %s summons paper.'
SummonDlgBuildingConf = 'Would you like to summon a %s to a nearby Toon building? This will cost %s summons papers.'
SummonDlgInvasionConf = 'Would you like to summon a %s invasion? This will cost %s summons papers.'
SummonDlgSkeleInvasionConf = 'Would you like to summon a %s Skelecog invasion? This will cost %s summons papers.'
SummonDlgDanceConf = 'Would you like to summon a Dance Unite? This will cost %s summons papers.'
...
SummonDlgBldgCapacityReached = 'Sorry, this street has too much Cog Structures. Try again on another street.'
...
SummonDlgDanceSuccess = 'The Cog has handed over its stolen jokes. You have obtained a Dance Unite!'
SummonDlgDanceCapacity = 'Sorry, but you have too many Dance Unites.'
...
BoardingTogglePractice = 'Toggle Practice'
BoardingPracticeEnabled = 'Practice Enabled'
...
BossbotRTMVP = '\x07Oh, I see that you are the most valuable Toon!\x07Here, take an extra pink slip.'
...
CogdoFlyingIntroMovieDialogue = ["You won't ruffle our feathers, Toons! We're using your Laff to power our offices, and you cannot stop us!",
                                 'Attention Toons! Use the propeller to fly around, grab Jokes, and keep laff from being destroyed.',
                                 'Ha, good luck! You will find us to be quite talon-ted!']
...
NametagColorShopColors = 'Colors'
NametagColorShopPanelColors = 'Panel Colors'
NametagColorShopCost = 'Cost: %s jellybeans'

MessageConfirmLeaveFacility = 'If you leave, your progress in this facility cannot be restored.\n\nAre you sure you want to leave the %s?'

TimeIntervals = (('weeks', 604800), ('days', 86400), ('hours', 3600), ('minutes', 60), ('seconds', 1))

def getTimeLeft(seconds, granularity = 2, fillEmptyFrom = 100):
    result = []
    i = 0
    for (name, count) in TimeIntervals[:granularity]:
        value = seconds // count
        if value or not seconds:
            seconds -= value * count
            result.append(str(value).rjust(2, '0'))
        elif fillEmptyFrom <= i:
            result.append('00')
        i += 1

    return ':'.join(result)

def getLastSeenTimestampString(timestamp):
    import time

    secondsPassed = int(time.time()) - int(timestamp)
    if timestamp == 0:
        return 'N/A'
    elif secondsPassed < 60:
        return 'Less than a minute ago'
    elif secondsPassed < 120:
        return '1 minute ago'
    elif secondsPassed < 3600:
        return '{0} minutes ago'.format(int(secondsPassed) // 60)
    elif secondsPassed < 7200 :
        return '1 hour ago'
    elif secondsPassed < 86400:
        return '{0} hours ago'.format(int(secondsPassed // (3600)))
    elif secondsPassed < 172800:
        return '1 day ago'
    elif secondsPassed < 2592000:
        return '{0} days ago'.format(int(secondsPassed // (86400)))
    elif secondsPassed < 5184000:
        return '1 month ago'
    elif secondsPassed < 31536000:
        return "{0} months ago".format(int(secondsPassed // (2592000)))
    elif secondsPassed < 63072000:
        return "1 year ago"
    else:
        return "Over a year ago"

DisclaimerText = 'Disclaimer:\nToontown: Gear Grind is in an early state. You may encounter bugs, glitches, crashes, etc. Everything is subject to change. Enjoy!'

LoginScreenLogin = 'Login'
LoginScreenCreateAccount = 'Create Account'
LoginScreenForgotPassword = 'Forgot Your Password?'
LoginScreenInvalidUsername = "An invalid username has been entered.\nIf you've recently registered, please wait a little and try again."
LoginScreenInvalidPassword = 'An invalid password has been entered.'
LoginScreenNoPassword = 'You must enter a password!'
LoginScreenUsernameSpace = 'Your username cannot contain any spaces.'
LoginScreenPasswordSpace = 'Your password cannot contain any spaces.'
LoginScreenUsernameLength = 'Your username cannot be longer than 40 characters.'
LoginScreenPasswordLength = 'Your password cannot be longer than 40 characters.'

LoadingScreenSlogans = ['Fun, Silly, Entertaining!',
 'Time For Silliness!',
 'Escape the Negativity Today.',
 'Toontown Is Always Welcoming.',
 'Click. Chat. Relax.',
 'Escape Work From Today.']

ClothingTicketAmount = 'Clothing Tickets: %s'
DisguisePageChangeDisguise = 'Change Disguise'
ChooseDisguise = 'Click on a Cog name to\nchange your disguise!'
ChangingYourDisguise = 'Changing Your Disguise...'

WagerOfferS = '\x01toonblue\x01%s:\x01black\x01\nSay there, %s! How about I take that fish off your hands for about a jellybean? The fish is %s'
WagerOfferP = '\x01toonblue\x01%s:\x01black\x01\nSay there, %s! How about I take that fish off your hands for about %s jellybeans? The fish is %s'
WagerLostS = 'Yikes! You lost a jellybean in profit on that deal...'
WagerLostP = 'Yikes! You lost %s jellybeans in profit on that deal...'
WagerWonS = 'Toontastic! You earned an extra jellybean on that deal!'
WagerWonP = 'Toontastic! You earned %s extra jellybeans on that deal!'
WagerDraw = 'Nice work! You sold that fish for market price.'

PetRemoveHat = 'Remove Hat'
...
FlunkyCogBuildingName = "Tutorial Tom's Building\nFlunky, Inc."
FlunkyBuildingIntroOne = ["I'm sorry, but the boss is upstairs.",
 "We're not going to let you see him that easily!",
 'As boss always says, "Toons must be sent back to the playground".',
 "I hope you're prepared -- your visit ends here."]
FlunkyBuildingIntroBoss = ['Welcome, servants!',
 "Now that we're all here, let's get to the news.",
 'I have successfully captured that pesky dog!',
 'Boss, something smells strange...',
 'Huh?',
 "Well, well, well! I thought that scent was a little toony.",
 "Are you looking for Tutorial Tom?",
 "I'm sorry, but he is busy working for us Cogs.",
 'Get them!!!']
FlunkyBuildingEpilogue = ['Hot diggity dog!',
 'The fresh air of freedom smells toontastic!',
 'Thanks for the rescue!',
 "That Flunky took most of my goodies, but here is 100 jellybeans.",
 "You know, these beans are quite special. They come from the land of...",
 "It's time to head back to work, Tom.",
 "I think it's time for you to go back to the playground."]
 
TurnInvisible = 'Turn Invisible'
TurnVisible = 'Turn Visible'

TeleportGreetingSwapNotify = 'Teleport greeting has been changed to "%s".'

DisguisePageChangeHead2Cog = 'Disguise Head'
DisguisePageChangeHead2Toon = 'Undisguise Head'

ToonDisconnected = '%s has unexpectedly disconnected.'
ToonDied = '%s has gone sad!'

PiggyBankAvailableIn = 'Piggy bank available in %s'
PiggyBankFullMessage = "Congratulations! You've filled up your piggy bank! You have been rewarded with some jellybeans."
PiggyBankFetchingInfo = 'Loading Piggy Bank...'
FillUpPiggyBank = 'Defeat Cogs to fill up the piggy bank!'

RevivePromptTitle = 'Revive?'
ToonRevived = '%s has revived!'
ReviveAsk = 'Do you want to revive? This will cost %s jellybeans. You currently have %s jellybeans.'
ReviveWaitingForToons = 'Waiting For Revive Responses...'