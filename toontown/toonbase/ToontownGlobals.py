...
WackyWestCameraFar = 12000.0
WackyWestCameraNear = 1.0
DreamlandCameraFar = 2000
DreamlandCameraNear = 1
...
GolfZone = 17000
PartyHood = 18000
ResistanceRangerHideout = 19000
HoodsAlwaysVisited = [17000, 18000]
FacilityZones = [SellbotFactoryInt,
 CashbotMintIntA,
 CashbotMintIntB,
 CashbotMintIntC,
 LawbotStageIntA,
...
WelcomeValleyGoofySpeedway = 23000
...
dnaMap = {Tutorial: 'toontown_central',
 ...
 GolfZone: 'golf_zone',
 ResistanceRangerHideout: 'resistance_ranger_hideout'}
hoodNameMap = {DonaldsDock: TTLocalizer.DonaldsDock,
 ...
 ResistanceRangerHideout: TTLocalizer.ResistanceRangerHideout}
...
NAMETAG_COLOR_COST = 500
MAX_SUMMONS = 1000

COG_SUMMONS_COST = 1
BUILDING_SUMMONS_COST = 2
OFFICE_SUMMONS_COST = 3
INVASION_SUMMONS_COST = 9
SKELE_INVASION_SUMMONS_COST = 12
DANCE_SUMMONS_COST = 1
SUE_COST = 1

SUE_REWARD_NONE = 0
SUE_REWARD_JELLYBEANS = 1
SUE_REWARD_CLOTHING_TICKET = 2
SUE_REWARD_GLOVE_TICKET = 4
SUE_REWARD_PINK_SLIP = 5
SUE_REWARD_UNITE = 6
SUE_REWARD_SOS = 7

KnockKnockCooldown = 180
Hood2KnockKnockHeal = {ToontownCentral: 5,
  WelcomeValleyBegin: 5,
  DonaldsDock: 12,
  DaisyGardens: 12,
  MinniesMelodyland: 12,
  TheBrrrgh: 14,
  DonaldsDreamland: 14}
