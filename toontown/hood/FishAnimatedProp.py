...
class FishAnimatedProp:
    ...
    def __init__(self, node):
        ...
        self.fish = Actor.Actor('phase_4/models/props/SZ_fish-mod', copy=0)
        ...
        self.track = Sequence(Wait(7 + 10 * random.random()), Func(self.fish.show), Parallel(self.fish.actorInterval('jump'), Sequence(Wait(0.25), Func(self.exitRipples.play, 0.75)), Sequence(Wait(1.14), Func(self.splash.play), SoundInterval(randomSplash, volume=0.6, node=self.fish))), Func(self.fish.hide))
