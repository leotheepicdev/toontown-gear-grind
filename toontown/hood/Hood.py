...
class Hood(StateData.StateData):
    ...
    def updateDiscordPresence(self):
        ...
        if zoneId != None and ZoneUtil.isWelcomeValley(zoneId):
            ...
            for shard in shards:
                ...
                activity = {
                    'details': base.cr.hoodMgr.getFullnameFromId(self.id) + ', ' + shardName,
                ...
                base.cr.discordPresence.updatePresence(activity, True)
    ...
    def exit(self):
        ...
        if base.wantDiscordPresence and base.haveDiscordOpen:
            base.cr.discordPresence.sendGeneral()
    ...
    def adjustDaylight(self, timeOfDay, elaspedTime):
        pass