...
from toontown.cogtower import DistributedCogTowerElevatorAI
from toontown.cogtower.DistributedCogTowerAI import DistributedCogTowerAI
...
class CSHoodDataAI(HoodDataAI.HoodDataAI):
    ...
    def startup(self):
        ...
        self.testElev2 = DistributedCogTowerElevatorAI.DistributedCogTowerElevatorAI(self.air, DistributedCogTowerAI(self.air))
        self.testElev2.generateWithRequired(ToontownGlobals.SellbotFactoryExt)
        ...
        if simbase.config.GetBool('want-boarding-groups', 1):
            ...
            self.boardingParty.setPracticeEnabled(1)
