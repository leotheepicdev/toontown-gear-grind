...
from toontown.cogtower import DistributedBattleCogTowerAI
from toontown.toonbase.ToontownBattleGlobals import *
from toontown.toonbase import ToontownGlobals
from .CogTowerPlannerAI import CogTowerPlannerAI

class DistributedCogTowerInteriorAI(DistributedObjectAI.DistributedObjectAI):
    def __init__(self, air, zoneId, bldg, toonIds):
        self.air = air
        DistributedObjectAI.DistributedObjectAI.__init__(self, air)
        self.zoneId = zoneId
        self.planner = CogTowerPlannerAI(self.zoneId)
    ...
    def __handleUnexpectedExit(self, toonId):
        ...
        if len(self.toons) == 0:
            ...
            if self.fsm.getCurrentState().getName() == 'Resting':
                ...
                self.bldg.destroyCogTowerInterior(self.zoneId)
    ...
    def __createFloorBattle(self):
        bossBattle = 0
        self.battle = DistributedBattleCogTowerAI.DistributedBattleCogTowerAI(self.air, self.zoneId, self.__handleRoundDone, self.__handleBattleDone, bossBattle = bossBattle)
