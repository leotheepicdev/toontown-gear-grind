...
class CogTowerInterior(Place.Place):
    notify = DirectNotifyGlobal.directNotify.newCategory('CogTowerInterior')

    def __init__(self, loader, parentFSM, doneEvent):
        Place.Place.__init__(self, loader, doneEvent)
        self.fsm = ClassicFSM.ClassicFSM('CogTowerInterior', [State.State('entrance', self.enterEntrance, self.exitEntrance, ['battle', 'walk']),
    ...
    def enter(self, requestStatus):
        ...
        self._telemLimiter = TLGatherAllAvs('CogTowerInterior', RotationLimitToH)
    ...
    def load(self):
        ...
        self.parentFSM.getStateNamed('cogTowerInterior').addChild(self.fsm)
        self.townBattle = TownBattle.TownBattle('town-battle-done')
        self.townBattle.load()

    def unload(self):
        Place.Place.unload(self)
        self.parentFSM.getStateNamed('cogTowerInterior').removeChild(self.fsm)
        del self.parentFSM
        del self.fsm
        self.ignoreAll()
