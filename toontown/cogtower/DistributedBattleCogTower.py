...
class DistributedBattleCogTower(DistributedBattleBase.DistributedBattleBase):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedBattleCogTower')
    camFOFov = 30.0
    ...
    def setBossBattle(self, value):
        ...
        self.battleMusic = loader.loadMusic('phase_7/audio/bgm/cog_tower_battle_music.ogg')
            ...
            if self.suits.index(suit) == leaderIndex:
                ...
                if self.bossBattle == 1:
                    ...
                    if suit.dna.name == 'null':
                        ...
                        styleName = suit.getStyleName()
                    taunt = SuitBattleGlobals.getFaceoffTaunt(styleName, suit.doId)
