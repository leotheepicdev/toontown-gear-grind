...
from toontown.suit import CogPlannerPercentages
...
class QuestMap(DirectFrame):
    ...
    def updateCogInfo(self):
        currPercentage = CogPlannerPercentages.CogHoodPercentageInfo.get(self.zoneId)
