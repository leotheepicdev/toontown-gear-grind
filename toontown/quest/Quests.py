...
class Quest:
    ...
    def checkNumCountryClubs(self, num):
        self.check(1, 'invalid num country clubs: %s' % num)
...
class TutorialTomBuildingQuest(CogQuest):
    trackCodes = ['c',
     'l',
     'm',
     's']
    ...
    def __init__(self, id, quest):
        CogQuest.__init__(self, id, quest)
        self.checkNumBuildings(self.quest[0])
    ...
    def getObjectiveStrings(self):
        ...
        if count == 1:
            text = TTLocalizer.QuestsTomBuildingQuestDescS
        else:
            text = TTLocalizer.QuestsTomBuildingQuestDescP
        return (text % {'count': count},)

    def getString(self):
        return TTLocalizer.QuestsTomBuildingQuestString % self.getObjectiveStrings()[0]
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        if count == 1:
            ...
            text = TTLocalizer.QuestsTomBuildingQuestDescP
        objective = text % {'count': count,}
        return TTLocalizer.QuestsTomBuildingQuestSCString % {'objective': objective}

    def getHeadlineString(self):
        return TTLocalizer.QuestsTomBuildingQuestHeadline
...
class CountryClubQuest(LocationBasedQuest):
    def __init__(self, id, quest):
        LocationBasedQuest.__init__(self, id, quest)
        self.checkNumCountryClubs(self.quest[1])

    def getNumQuestItems(self):
        return self.getNumCountryClubs()

    def getNumCountryClubs(self):
        return self.quest[1]

    def getCompletionStatus(self, av, questDesc, npc = None):
        questId, fromNpcId, toNpcId, rewardId, toonProgress = questDesc
        questComplete = toonProgress >= self.getNumCountryClubs()
        return getCompleteStatusWithNpc(questComplete, toNpcId, npc)

    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            return CompleteString
        elif self.getNumCountryClubs() == 1:
            return ''
        else:
            return TTLocalizer.QuestsCountryClubQuestProgressString % {'progress': questDesc[4],
             'num': self.getNumCountryClubs()}

    def getObjectiveStrings(self):
        count = self.getNumCountryClubs()
        if count == 1:
    ...
    def getSCStrings(self, toNpcId, progress):
        if progress >= self.getNumCountryClubs():
            return getFinishToonTaskSCStrings(toNpcId)
        count = self.getNumCountryClubs()
        if count == 1:
    ...
    def doesCountryClubCount(self, avId, location, avList):
        return self.isLocationMatch(location)
...
QuestDict = {
 ...
 121: (TT_TIER, Cont, (RecoverItemQuest, ToontownGlobals.ToontownCentral, 1, 2, Easy, Any, 'type'), Same, 2002, NA, 142, TTLocalizer.QuestDialogDict[121]),
 130: (TT_TIER, Cont, (DeliverItemQuest, 6), ToonHQ, 2003, NA, 131, TTLocalizer.QuestDialogDict[130]),
 131: (TT_TIER, Cont, (RecoverItemQuest, ToontownGlobals.ToontownCentral, 1, 3, Easy, Any, 'type'), Same, 2003, NA, 142, TTLocalizer.QuestDialogDict[131]),
 140: (TT_TIER, Cont, (DeliverItemQuest, 4), ToonHQ, 2005, NA, 141, TTLocalizer.QuestDialogDict[140]),
 141: (TT_TIER, Cont, (RecoverItemQuest, ToontownGlobals.ToontownCentral, 1, 1, Easy, Any, 'type'), Same, 2005, NA, 142, TTLocalizer.QuestDialogDict[141]),
 ...
 4238: (MM_TIER + 1,
        ...
        (RecoverItemQuest,
         ...
         NA,
         4239,
         TTLocalizer.QuestDialogDict[4238]),
 4239: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4018),
        Same,
        4127,
        4003,
        NA,
        TTLocalizer.QuestDialogDict[4239]),
 4240: (MM_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        4241,
        TTLocalizer.QuestDialogDict[4240]),
 4241: (MM_TIER + 1,
        Cont,
        (BuildingQuest,
         ToontownGlobals.MinniesMelodyland,
        ...
        NA,
        4242,
        TTLocalizer.QuestDialogDict[4241]), 
 4242: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4019),
        Same,
        4118,
        NA,
        4243,
        TTLocalizer.QuestDialogDict[4242]),
 4243: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4019),
        Same,
        ...
        NA,
        4244,
        TTLocalizer.QuestDialogDict[4243]),        
 4244: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4019),
        Same,
        ...
        NA,
        4245,
        TTLocalizer.QuestDialogDict[4244]),
 4245: (MM_TIER + 1,
        Cont,
        (VisitQuest,),
        Same,
        ...
        4004,
        NA,
        TTLocalizer.QuestDialogDict[4245]),
 4246: (MM_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        4247,
        TTLocalizer.QuestDialogDict[4246]),
 4247: (MM_TIER + 1,
        Cont,
        (VisitQuest,),
        Same,
        ...
        NA,
        4248,
        TTLocalizer.QuestDialogDict[4247]),
 4248: (MM_TIER + 1,
        Cont,
        (RecoverItemQuest,
         Anywhere,
        ...
        NA,
        4249,
        TTLocalizer.QuestDialogDict[4248]),
 4249: (MM_TIER + 1,
        Cont,
        (CogQuest,
         ToontownGlobals.MinniesMelodyland,
        ...
        NA,
        4250,
        TTLocalizer.QuestDialogDict[4249]),
 4250: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4020),
        Same,
        4323,
        4005,
        NA,
        TTLocalizer.QuestDialogDict[4250]),     
 4251: (MM_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        4252,
        TTLocalizer.QuestDialogDict[4251]),
 4252: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4021),
        Same,
        4326,
        NA,
        4253,
        TTLocalizer.QuestDialogDict[4252]),
 4253: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4021),
        Same,
        ...
        NA,
        4254,
        TTLocalizer.QuestDialogDict[4253]),
 4254: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4021),
        Same,
        ...
        NA,
        4255,
        TTLocalizer.QuestDialogDict[4254]),
 4255: (MM_TIER + 1,
        Cont,
        (CogQuest,
         Anywhere,
        ...
        NA,
        4256,
        TTLocalizer.QuestDialogDict[4255]),
 4256: (MM_TIER + 1,
        Cont,
        (VisitQuest,),
        Same,
        ...
        NA,
        4257,
        TTLocalizer.QuestDialogDict[4256]),
 4257: (MM_TIER + 1,
        Cont,
        (RecoverItemQuest,
         Anywhere,
        ...
        NA,
        4258,
        TTLocalizer.QuestDialogDict[4257]),
 4258: (MM_TIER + 1,
        Cont,
        (BuildingQuest,
         ToontownGlobals.MinniesMelodyland,
        ...
        NA,
        4259,
        TTLocalizer.QuestDialogDict[4258]),
 4259: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4023),
        Same,
        4326,
        NA,
        4260,
        TTLocalizer.QuestDialogDict[4259]),
 4260: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4027),
        Same,
        4315,
        4006,
        NA,
        TTLocalizer.QuestDialogDict[4260]),
 4261: (MM_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        4262,
        TTLocalizer.QuestDialogDict[4261]),     
 4262: (MM_TIER + 1,
        Cont,
        (VisitQuest,),
        Same,
        ...
        NA,
        4263,
        TTLocalizer.QuestDialogDict[4262]),
 4263: (MM_TIER + 1,
        Cont,
        (RecoverItemQuest,
         Anywhere,
        ...
        NA,
        4264,
        TTLocalizer.QuestDialogDict[4263]),
 4264: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4024),
        Same,
        4222,
        NA,
        4265,
        TTLocalizer.QuestDialogDict[4264]),
 4265: (MM_TIER + 1,
        Cont,
        (RecoverItemQuest,
         Anywhere,
        ...
        NA,
        4266,
        TTLocalizer.QuestDialogDict[4265]),
 4266: (MM_TIER + 1,
        Cont,
        (DeliverItemQuest, 4024),
        Same,
        ...
        NA,
        4267,
        TTLocalizer.QuestDialogDict[4266]),
 4267: (MM_TIER + 1,
        Cont,
        (VisitQuest,),
        Same,
        ...
        4007,
        NA,
        TTLocalizer.QuestDialogDict[4267]),
 4268: (MM_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        4270,
        TTLocalizer.QuestDialogDict[4268]),
 4269: (MM_TIER + 1,
        Cont,
        (CogQuest,
         Anywhere,
        ...
        4008,
        NA,
        TTLocalizer.QuestDialogDict[4269]),
 4270: (MM_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        4272,
        TTLocalizer.QuestDialogDict[4270]),
 4271: (MM_TIER + 1,
        Cont,
        (RecoverItemQuest,
         1,
        ...
        4009,
        NA,
        TTLocalizer.QuestDialogDict[4271]),
 4272: (MM_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        4274,
        TTLocalizer.QuestDialogDict[4272]),
 4273: (MM_TIER + 1,
        Cont,
        (RecoverItemQuest,
         35,
        ...
        4010,
        NA,
        TTLocalizer.QuestDialogDict[4273]),
 4274: (MM_TIER + 2,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        4275,
        TTLocalizer.QuestDialogDict[4274]),
 4275: (MM_TIER + 2,
        Cont,
        (CogTrackQuest,
         ToontownGlobals.CashbotHQ,
        ...
        308,
        NA,
        TTLocalizer.QuestDialogDict[4275]),
 4276: (MM_TIER + 2,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        4277,
        TTLocalizer.QuestDialogDict[4276]),
 4277: (MM_TIER + 2,
        Cont,
        (MintQuest, ToontownGlobals.CashbotHQ, 2),
        Same,
        Same,
        4011,
        NA,
        TTLocalizer.QuestDialogDict[4277]),       
 4500: (MM_TIER + 1,
        Start,
        (CogQuest,
         ToontownGlobals.MinniesMelodyland,
 ...
 5193: (BR_TIER + 1,
        Start,
        (MintQuest, ToontownGlobals.CashbotHQ, 1),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 5170: (BR_TIER + 1,
        Start,
        (SkelecogQuest, ToontownGlobals.CashbotMintIntA, 4),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 5400: (BR_TIER + 1,
        ...
        NA,
        5401,
        TTLocalizer.QuestDialogDict[5400]),
 5401: (BR_TIER + 1,
        Cont,
        (CogTrackQuest,
        ...
        NA,
        5402,
        TTLocalizer.QuestDialogDict[5401]),
 5402: (BR_TIER + 1,
        Cont,
        (RecoverItemQuest,
         ToontownGlobals.LawbotHQ,
        ...
        NA,
        5403,
        TTLocalizer.QuestDialogDict[5402]),
 5403: (BR_TIER + 1,
        Cont,
        (DeliverItemQuest, 3028),
        Same,
        ToonHQ,
        4100,
        NA,
        TTLocalizer.QuestDialogDict[5403]),
 5404: (BR_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        5405,
        TTLocalizer.QuestDialogDict[5404]),
 5405: (BR_TIER + 1,
        Cont,
        (CogTrackQuest,
         ToontownGlobals.PolarPlace,
         ...
         4102,
         NA,
         TTLocalizer.QuestDialogDict[5405]),   
 5406: (BR_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        5407,
        TTLocalizer.QuestDialogDict[5406]),
 5407: (BR_TIER + 1,
        Cont,
        (BuildingQuest,
         ToontownGlobals.TheBrrrgh,
        ...
        4104,
        NA,
        TTLocalizer.QuestDialogDict[5407]),
 5408: (BR_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        5409,
        TTLocalizer.QuestDialogDict[5408]),
 5409: (BR_TIER + 1,
        Cont,
        (CogQuest,
        ...
        4106,
        NA,
        TTLocalizer.QuestDialogDict[5409]),
 5410: (BR_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        5411,
        TTLocalizer.QuestDialogDict[5410]),
 5411: (BR_TIER + 1,
        Cont,
        (RecoverItemQuest,
        ...
        4108,
        NA,
        TTLocalizer.QuestDialogDict[5411]),
 5412: (BR_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        5413,
        TTLocalizer.QuestDialogDict[5412]),
 5413: (BR_TIER + 1,
        Cont,
        (RecoverItemQuest,
         Anywhere,
        ...
        4110,
        NA,
        TTLocalizer.QuestDialogDict[5413]),
 5414: (BR_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        5415,
        TTLocalizer.QuestDialogDict[5414]),
 5415: (BR_TIER + 1,
        Cont,
        (BuildingQuest,
         ToontownGlobals.PolarPlace,
        ...
        4112,
        NA,
        TTLocalizer.QuestDialogDict[5415]),
 5416: (BR_TIER + 1,
        Start,
        (VisitQuest,),
        Any,
        ...
        NA,
        5417,
        TTLocalizer.QuestDialogDict[5416]),
 5417: (BR_TIER + 1,
        Cont,
        (StageQuest, ToontownGlobals.LawbotHQ, 3),
        Same,
        Same,
        309,
        NA,
        TTLocalizer.QuestDialogDict[5417]),
 5500: (BR_TIER + 1,
        Start,
        (CogQuest,
         ToontownGlobals.TheBrrrgh,
 ...
 5501: (BR_TIER + 1,
        ...
        100,
        NA,
        TTLocalizer.QuestDialogDict[5501]),
 5502: (BR_TIER + 1,
        Start,
        (RecoverItemQuest,
         Anywhere,
        ...
        100,
        NA,
        TTLocalizer.QuestDialogDict[5502]),
 5503: (BR_TIER + 1,
        Start,
        (RecoverItemQuest,
         Anywhere,
        ...
        100,
        NA,
        TTLocalizer.QuestDialogDict[5503]),
 5504: (BR_TIER + 1,
        Start,
        (RecoverItemQuest,
         Anywhere,
        ...
        100,
        NA,
        TTLocalizer.QuestDialogDict[5504]),
 5505: (BR_TIER + 1,
        Cont,
        (RecoverItemQuest,
         Anywhere,
        ...
        (5254,
         ...
         5283,
         5284),
        TTLocalizer.QuestDialogDict[5505]),
 5506: (BR_TIER + 1,
        Cont,
        (RecoverItemQuest,
         Anywhere,
        ...
        (5254,
         ...
         5283,
         5284),
        TTLocalizer.QuestDialogDict[5506]),
 5507: (BR_TIER + 1,
        Cont,
        (RecoverItemQuest,
         Anywhere,
        ...
        (5254,
         ...
         5283,
         5284),
        TTLocalizer.QuestDialogDict[5507]),
 5508: (BR_TIER + 1,
        Cont,
        (RecoverItemQuest,
         Anywhere,
        ...
        (5254,
         ...
         5283,
         5284),
        TTLocalizer.QuestDialogDict[5508]),
 903: (BR_TIER + 2,
       Start,
       (VisitQuest,),
       Any,
 ...
 6233: (DL_TIER,
        Cont,
        (CountryClubQuest, ToontownGlobals.BossbotHQ, 4),
        Same,
        Same,
        NA,
        6234,
 ...
 6293: (DL_TIER + 1,
        ...
        NA,
        6294,
        TTLocalizer.QuestDialogDict[6293]),
 6294: (DL_TIER + 1,
        Start,
        (CogQuest,
         ToontownGlobals.DonaldsDreamland,
        ...
        4213,
        NA,
        TTLocalizer.QuestDialogDict[6294]),
 6301: (DL_TIER,
        Start,
        (CogQuest,
         ToontownGlobals.BossbotHQ,
 ...
 6327: (DL_TIER,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntA, 5),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 6329: (DL_TIER,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntC, 3),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 6330: (DL_TIER,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntD, 3),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 6331: (DL_TIER,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntA, 5),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 6332: (DL_TIER,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntB, 4),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 6333: (DL_TIER,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntC, 3),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 7278: (DL_TIER + 1,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntA, 10),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 7279: (DL_TIER + 1,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntB, 8),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 7280: (DL_TIER + 1,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntC, 6),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 7281: (DL_TIER + 1,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntD, 4),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 7282: (DL_TIER + 1,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntA, 10),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 7283: (DL_TIER + 1,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntB, 8),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 7284: (DL_TIER + 1,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntC, 6),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8229: (DL_TIER + 2,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntA, 16),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8230: (DL_TIER + 2,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntB, 14),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8231: (DL_TIER + 2,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntC, 12),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8232: (DL_TIER + 2,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntD, 10),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8233: (DL_TIER + 2,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntA, 16),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8234: (DL_TIER + 2,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntB, 14),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8235: (DL_TIER + 2,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntC, 12),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 8400: (DL_TIER + 3,
        ...
        NA,
        8401,
        TTLocalizer.QuestDialogDict[8400]),
 8401: (DL_TIER + 3,
        Start,
        (RecoverItemQuest,
         Anywhere,
        ...
        310,
        NA,
        TTLocalizer.QuestDialogDict[8401]),
 9101: (DL_TIER + 3,
        Start,
        (CogQuest,
         Anywhere,
 ...
 9239: (DL_TIER + 3,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntA, 35),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 9240: (DL_TIER + 3,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntB, 30),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 9242: (DL_TIER + 3,
        Start,
        (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntC, 25),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 9246: (DL_TIER + 3,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntA, 35),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 9247: (DL_TIER + 3,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntB, 30),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 9248: (DL_TIER + 3,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntC, 25),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 9249: (DL_TIER + 3,
        Start,
        (StageQuest, ToontownGlobals.LawbotStageIntD, 20),
        Any,
        ToonHQ,
        Any,
        NA,
 ...
 10148: (ELDER_TIER,
         Start,
         (CountryClubQuest, ToontownGlobals.BossbotHQ, 10),
         Any,
         ToonHQ,
         Any,
         NA,
 ...
 10211: (ELDER_TIER,
         Start,
         (StageQuest, ToontownGlobals.LawbotHQ, 10),
         Any,
         ToonHQ,
         Any,
         NA,
 ...
 10213: (ELDER_TIER,
         Start,
         (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntA, 30),
         Any,
         ToonHQ,
         Any,
         NA,
 ...
 10214: (ELDER_TIER,
         Start,
         (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntB, 25),
         Any,
         ToonHQ,
         Any,
         NA,
 ...
 10215: (ELDER_TIER,
         Start,
         (CountryClubQuest, ToontownGlobals.BossbotCountryClubIntC, 20),
         Any,
         ToonHQ,
         Any,
         NA,
...
class ClothingTicketReward(Reward):
    ...
    def sendRewardAI(self, av):
        av.addClothingTickets(self.getAmount())
...
class GloveTicketReward(Reward):
    def __init__(self, id, reward):
        Reward.__init__(self, id, reward)
    ...
    def sendRewardAI(self, av):
        av.addGloveTickets(self.getAmount())

    def getString(self):
        return TTLocalizer.QuestsGloveTicketReward

    def getPosterString(self):
        return TTLocalizer.QuestsGloveTicketRewardPoster
...
def getNextRewards(numChoices, tier, av):
    ...
    for rewardId in getRewardsInTier(tier):
        ...
        if getRewardClass(rewardId) == GloveTicketReward:
            gloveTicketNum = av.getGloveTickets()
...
RewardDict = {100: (MaxHpReward, 1),
 ...
 108: (MaxHpReward, 9),
 109: (MaxHpReward, 10),
 130: (MaxHpReward, 1), # TTC
 131: (MaxHpReward, 2), # TTC
 ...
 306: (TeleportReward, ToontownGlobals.GoofySpeedway),
 307: (TeleportReward, ToontownGlobals.SellbotHQ),
 308: (TeleportReward, ToontownGlobals.CashbotHQ),
 309: (TeleportReward, ToontownGlobals.LawbotHQ),
 310: (TeleportReward, ToontownGlobals.BossbotHQ),
 ...
 700: (MaxMoneyReward, 50), # TTC
 701: (MaxMoneyReward, 60), # DD
 702: (MaxMoneyReward, 80), # DG
 703: (MaxMoneyReward, 100), # MM
 704: (MaxMoneyReward, 120), # BR
 705: (MaxMoneyReward, 150), # DL
 706: (MaxMoneyReward, 200), # DL
 707: (MaxMoneyReward, 250), # DL
