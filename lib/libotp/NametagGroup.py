...
class NametagGroup:
    ...
    def setAvatarType(self, type):
        self.m_avatar_type = type
        
    def getAvatarType(self):
        return self.m_avatar_type
    ...
    def setNametagColor(self, nametagColor):
        self.m_nametag_color = nametagColor
        
    def getNametagColor(self):
        return self.m_nametag_color
    ...
    def setBalloonColor(self, color):
        self.m_balloon_color = color
