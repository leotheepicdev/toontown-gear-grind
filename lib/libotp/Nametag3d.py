...
class Nametag3d(Nametag, PandaNode):
    ...
    def generateChat(self, balloon):
        ...
        balloon_result = balloon.generate(text, self.m_group.getChatFont(), self.m_wordwrap,
                                          ...
                                          reversed, new_button, allowTransparency)
    ...
    def generateName(self):
        ...
        if self.m_group.getNametagColor() != -1:
            v56 = Vec4(NametagGlobals.getPlayerNameFg(self.m_group.getAvatar().getNametagColor()))
            v54 = Vec4(NametagGlobals.getPlayerNameBg(self.m_group.getAvatar().getNametagPanelColor(), v4))
        else:
            v56 = Vec4(NametagGlobals.getNameFg(self.m_group.getColorCode(), v4, Settings['oldNametagColors']))
        ...
        if label86:
            ...
            if self.m_has_draw_order and self.m_name_icon:
                bin = config.GetString('nametag-fixed-bin', 'fixed')
