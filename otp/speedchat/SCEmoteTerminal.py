...
from otp.otpbase.OTPLocalizer import EmoteList, EmoteWhispers, DisguiseEmoteWhispers
...
def decodeSCDisguiseEmoteWhisperMsg(emoteId, avName):
    if emoteId >= len(DisguiseEmoteWhispers):
        return None
    return DisguiseEmoteWhispers[emoteId] % avName
