...
class ChatManager(DirectObject.DirectObject):
    ...
    def sendSCChatMessage(self, msgIndex, cfType=CFSpeech):
        base.talkAssistant.sendOpenSpeedChat(1, msgIndex, cfType)
    ...
    def sendSCWhisperMessage(self, msgIndex, whisperAvatarId, toPlayer):
        if toPlayer:
            ...
            base.cr.chatRelay.relayWhisperSC(1, msgIndex, whisperAvatarId)
    ...
    def sendSCCustomWhisperMessage(self, msgIndex, whisperAvatarId, toPlayer):
        if toPlayer:
            ...
            base.cr.chatRelay.relayWhisperSC(3, msgIndex, whisperAvatarId)
    ...
    def sendSCEmoteWhisperMessage(self, emoteId, whisperAvatarId, toPlayer):
        if toPlayer:
            ...
            base.cr.chatRelay.relayWhisperSC(2, emoteId, whisperAvatarId)
            
    def sendSCDisguiseEmoteWhisperMessage(self, emoteId, whisperAvatarId):
        base.cr.chatRelay.relayWhisperSC(4, emoteId, whisperAvatarId)
            
    def sendSCDisguiseEmoteChatMessage(self, emoteId):
        base.talkAssistant.sendOpenSpeedChat(4, emoteId)
