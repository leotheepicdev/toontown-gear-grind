...
if not accountServer:
    accountServer = 'https://geargrind.tech'
...
class TTAccount:
    ...
    def talk(self, operation, data = {}):
        ...
        op2Php = {'play': 'play',
         ...
         'authenticateDelete': 'api/authDelete/',
        ...
        newWebOperations = ('authenticateParentPasswordNewStyle', 'authenticateParentUsernameAndPassword', 'authenticateDeleteNewStyle', 'authenticateDelete')
