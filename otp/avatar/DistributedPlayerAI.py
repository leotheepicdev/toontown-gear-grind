...
class DistributedPlayerAI(DistributedAvatarAI.DistributedAvatarAI, PlayerBase.PlayerBase):
    ...
    def d_WishNameState(self, wishNameState):
        self.sendUpdate('WishNameState', [wishNameState])
        
    def b_WishNameState(self, wishNameState):
        self.WishNameState(wishNameState)
        self.d_WishNameState(wishNameState)
