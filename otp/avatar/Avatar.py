...
from lib.libotp import Nametag, NametagGroup
from lib.libotp._constants import CFSpeech, CFThought, CFTimeout, CFPageButton, CFNoQuitButton, CFQuitButton
...
class Avatar(Actor, ShadowCaster):
    ...
    def __init__(self, other = None):
        ...
        self.__chatFont = OTPGlobals.getInterfaceFont()
    ...
    def setChatFont(self, font):
        self.__chatFont = font
        self.nametag.setChatFont(font)
        
    def setAvatarType(self, type):
        self.avatarType = type
        self.nametag.setAvatarType(type)
